...
// start contents here...
  ...
  if($accesslevel >= 4) {
	...
	$res11query="SELECT applic_date, holidayname, holidaytype, shiftin, shiftout FROM tblhrtaholidays WHERE idhrtaholidays=$idhrtaholidays";
  ...
  <?php
	...
	if($holidaytype11 == "special") { $hdtypselspecial="selected"; $hdtypselcity=""; $hdtypsellegal=""; $hdtypselshortened=""; $hdtypselall=""; $hdtypeselnone=""; }
	else if($holidaytype11 == "city") { $hdtypselspecial=""; $hdtypselcity="selected"; $hdtypsellegal=""; $hdtypselshortened=""; $hdtypselall=""; $hdtypeselnone=""; }
	else if($holidaytype11 == "legal") { $hdtypselspecial=""; $hdtypselcity=""; $hdtypsellegal="selected"; $hdtypselshortened=""; $hdtypselall=""; $hdtypeselnone=""; }
	else if($holidaytype11 == "shortened") { $hdtypselspecial=""; $hdtypselcity=""; $hdtypsellegal=""; $hdtypselshortened="selected"; $hdtypselall=""; $hdtypeselnone=""; }
	else if($holidaytype11 == "all") { $hdtypselspecial=""; $hdtypselcity=""; $hdtypsellegal=""; $hdtypselshortened=""; $hdtypselall="selected"; $hdtypeselnone=""; }
	else { $hdtypselspecial=""; $hdtypselcity=""; $hdtypsellegal=""; $hdtypselshortened=""; $hdtypselall=""; $hdtypeselnone="selected"; }
	echo "<option value='' $hdtypeselnone>select type</option>";
	echo "<option value=\"city\" $hdtypselcity>City holiday</option>";
