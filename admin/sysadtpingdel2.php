...
// start contents here...
  ...
  $result12 = mysql_query("DELETE FROM tblsysadping WHERE sysadpingid = \"$sysadpingid\"", $dbh);

  echo "<tr><td>status</td><td><font color=\"green\"><b>OK - deleted</b></font></td></tr>";
  echo "<td colspan=\"2\" align=\"center\"><form action=\"sysadtpingconfig.php?loginid=$loginid\" method=\"post\"><input type=\"submit\" value=\"Back to SysAd Ping Config\"></form></td></tr>";
