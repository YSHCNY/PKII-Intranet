...
//	  $employeeid = $myrow0[0];
	...
	echo "<p>Duration start date changed for: <b>$employeeid - $name_last, $name_first $name_middle[0]</b></p>";

	$result = mysql_query("UPDATE tblprojassign SET durationfrom = '$newdate'
