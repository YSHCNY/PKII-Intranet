...
if ($found == 1)
{
  ...
  $result11 = mysql_query("SELECT tblfinacctspayable.acctspayablenumber, tblfinacctspayable.payee, tblfinacctspayable.date, tblfinacctspayabletot.debittot, tblfinacctspayabletot.credittot FROM tblfinacctspayable LEFT JOIN tblfinacctspayabletot ON tblfinacctspayable.acctspayablenumber = tblfinacctspayabletot.acctspayablenumber WHERE tblfinacctspayable.acctspayablenumber=\"$acctspayablenumber\"", $dbh);
...
//    $acctspayablenumber11 = $myrow11[0];
  ...
  echo "<tr><td colspan=\"2\" align=\"center\"><font color=\"red\"><b>Deleting AP record.</td></tr>";
  echo "<tr><td colspan=\"2\">Details:<br>";
  echo "APno:$acctspayablenumber<br>";
  ...
  {
    echo "<form method=\"post\" action=\"finvouchapdel2.php?loginid=$loginid&apn=$acctspayablenumber\">";
