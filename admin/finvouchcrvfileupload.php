<?php
//
// finvouchcrvfileupload.php 20250505
...
$cashreceipttotid = (isset($_POST['cashreceipttotid'])) ? $_POST['cashreceipttotid'] :'';
$cashreceiptnumber = (isset($_POST['cashreceiptnumber'])) ? $_POST['cashreceiptnumber'] :'';
$btnCRVfileupload = (isset($_POST['btnCRVfileupload'])) ? $_POST['btnCRVfileupload'] :'';

$target_path0 = "./uploads/finvouch";
$filename = basename( $_FILES['uploadedfile']['name'] );
$filename1 = str_replace(' ', '_', $filename);
if($filename1 != "") { $filenamefin = $cashreceiptnumber."_".$filename1; }
...
// start contents here
    ...
    if($filename1!="" && $btnCRVfileupload==1) {

    $res2query=""; $result2="";
    $res2query = "UPDATE tblfincashreceipttot SET filepath=\"$target_path0\", filename=\"$filenamefin\" WHERE cashreceipttotid=$cashreceipttotid AND cashreceiptnumber=\"$cashreceiptnumber\"";
  ...
  if(move_uploaded_file($_FILES['uploadedfile']['tmp_name'], $target_path)) {
    ...
    $adminlogdetails = "$loginid:$adminloginuid - Uploaded file attachment for Cash Receipt voucher $cashreceiptnumber id:$cashreceipttotid filepath:$target_path0, filename:$filenamefin";
