...
// start contents here
  ...
  echo "<tr><th colspan=\"2\">Accounts Payable Voucher - change APV no.</th></tr>";
	echo "<form action=\"finvouchapvchgnum2.php?loginid=$loginid&apvn=$apnumber&apvdt=$apdate\" method=\"post\" name=\"form1\">";
	echo "<tr><th align=\"right\">Date</th><td><strong>$apdate</strong>";

	echo "</td></tr>";
	echo "<tr><th align=\"right\">APV no.</th><td><input class='form-control' name=\"apnumbernew\" value=\"$apnumber\"></td></tr>";
