...
//  echo "<p><font color=\"red\"><b>Modify CV record date...</b></font></p>";
  ...
  $result11 = mysql_query("SELECT disbursementid, disbursementnumber, date, payee FROM tblfindisbursement WHERE disbursementnumber=\"$cvnumber\" AND date=\"$cvdate0\"", $dbh);
    ...
    $found11 = 1;
		...
		echo "<p>vartest id:$disbursementid11, num:$cvnumber, dt0:$date11, dt1:$cvdate, pyee:$payee11</p>";
...
// create log
    ...
    { $adminuid=$myrow16[0]; }
    $adminlogdetails = "$loginid:$adminloginuid - Modified date from:$date11 to:$cvdate of CV:$cvnumber, payee:$payee11";
