...
?> <!-- div class="row" -->
	...
	<p class="mb-0 maintext fw-bold text-capitalize fs-4">overtime request </p>
	<p class = 'submaintext fs-5' >Authirization Form (HRD-F-11)</p>
	</div>
...
?>
	...
	<div class="row mt-4">
		...
		<div class="col-lg-6">
			<div class = 'mb-4'>
				...
				<input type="date" class = 'border-0 maintext fs-4 px-3  ' name="dateapplic" value="<?php echo $datenow; ?>" readonly>
			</div>
	...
	<div class = 'mb-4'>
	<p class="text-muted fs-5 mb-1">Overtime date</p>
	<input type="date" class = 'rounded-3 maintext fs-4 px-3 border py-2 ' id="stamprequest" name="stamprequest" value="<?php echo $datenow; ?>">
	</div>
...
?>
<div class = 'mb-4'>
	<p class="text-muted fs-5 mb-1">Duration of Overtime</p>
		<input type="text" class="smalltext rounded-3 maintext fs-4 px-3 border py-2 " name="durationFrom" value="<?php echo $durfrhh; ?>">
		<input type="text" class="smalltext rounded-3 maintext fs-4 px-3 border py-2 " name="durationFrom1" value="<?php echo $durfrmm; ?>"><span class = 'px-3'>to</span>
		<input type="text" class="smalltext rounded-3 maintext fs-4 px-3 border py-2 " name="durationTo" value="<?php echo $durtohh; ?>">
		<input type="text" class="smalltext rounded-3 maintext fs-4 px-3 border py-2 " name="durationTo1" value="<?php echo $durtomm; ?>"> 
		</div>
...
?>
	...
	<div class = 'mb-4'>
	<p class="text-muted fs-5 mb-1">Reasons for Overtime</p>
