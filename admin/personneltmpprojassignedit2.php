...
if ($found == 1)
{
  ...
  $result2 = mysql_query("UPDATE tblprojassign0 SET
	...
	WHERE employeeid1='$employeeid' AND projectassign0id = $projectassign0id", $dbh) or die ("Couldn't execute query.".mysql_error());
  ...
  echo "<p><a href=personneltmpprojassignedit.php?loginid=$loginid&eid=$employeeid&prjid=$projectassign0id>Back to Edit tmp.Project Assignment</a></p>";
