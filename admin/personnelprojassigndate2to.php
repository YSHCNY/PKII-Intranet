...
if ($found == 1)
{
     ...
     echo "<p><font size=1>Directory >> Manage Personnel >> Edit Project Assignment >> Change date_to project duration2</font></p>";

     echo "<table border=1 spacing=0 cellspacing=0 cellpadding=0>";
     echo "<tr><td bgcolor=blue colspan=2><font color=white><b>Change Project Duration2 (To)</b></font></td></tr>";
...
//	  $employeeid = $myrow[0];
	...
	echo "<tr><td>Current Date (To)</td><td align=center>$durationto2<br><font size=1><i>YYYY-MM-DD</i></font></td></tr>";
	echo "<tr><td>New Date (To)</td><td>";

	echo "<form action=personnelprojassigndate2to2.php?loginid=$loginid&eid=$employeeid&prjid=$projassignid method=POST>";
