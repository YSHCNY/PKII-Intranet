...
?>
  ...
  <div class="row">
    ...
    <div class="col-md-2"><img src="./images/Icon_gray_Contact_team.png" alt="Contact_zen_team" width="80" height="80"><br><p style="color:#727880;">Contact PKIIzen Team</p><?php // echo "<a href=\"index.php?lst=1&lid=$loginid&sess=$session&p=385.php\">"; ?></div>
