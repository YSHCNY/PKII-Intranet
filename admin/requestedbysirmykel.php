...
// edit body-header
     ...
     echo '<form method="post" action="requestedbysirmykel.php?loginid='.$loginid.'">';
     ?>
     ...
     $grandTotalDebit = 0;
        ...
        $companyid15 = '';
        $contactid15 = '';
        $subDisbursement = "SELECT * FROM tblfincashreceipt WHERE date BETWEEN '".$fromDate."' AND '".$toDate."' AND glcode = '10.10.467'";
        ...
        while($rowDisbursement = $subDisbursementResult->fetch_assoc()) 
        {
          ...
          if($identifier != $rowDisbursement['cashreceiptnumber'])
          {
          echo "<tr>";
            echo "<td colspan='2'>Ref No: <b><u>".$rowDisbursement['cashreceiptnumber']."</b></u></td>";
...
$explanationfin = str_replace("'", "", $rowDisbursement['explanation']);
            echo "<td colspan='1'>".$rowDisbursement['cashreceiptnumber'] ."</td>";
...
$explanationfin = str_replace("'", "", $rowDisbursement['explanation']);
	...
	$particularsfin=""; $explanationfin="";            
            ...
            $identifier = $rowDisbursement['cashreceiptnumber'];
