...
// start contents here
?>
<div class = 'shadow p-5 mx-1 my-3'>
<p class="text-center fs-3 fw-bold mb-0">Edit User Form</p>
<p class = 'fs-5 text-muted text-center'>Edit user info and access.</p>
...
<?php
    ...
    echo "<div>";
    echo "<p class = ' fs-3 mb-0'><span class = 'fw-bold' > $name_first12 $name_middle12[0]. $name_last12 </span> </p>";
 
  echo "</div>";


    echo "<form action=\"mngadmuseredit2.php?loginid=$loginid&admlid=$adminloginid\" method=\"post\">";
    echo "<div class = 'mt-3'><p class = 'fs-5 text-muted mb-0'>Username</p>";
    echo "<input class = 'bg-white border rounded-2 px-3 py-2' name=\"adminuid\" value=\"$adminuid11\"></div>";
   
    echo "<div class = 'mt-3'><p  class = 'fs-5 text-muted mb-0 text-capitalize'>link to personnel</p>";
...
//    echo "&nbsp;&nbsp;<a href=\"mngadmuserchgpers.php?loginid=$loginid&admid=$adminloginid\">Change</a>";
    ...
    echo "<div class = 'mt-3'><p  class = 'fs-5 text-muted mb-0'>Access Level</p>";
    ...
    echo "<div class = 'mt-5'>
    <p class = 'fs-4 text-muted' >Status</p>
   ";
    echo "<p>$remarksfin</p>";
    if($attempt15>=$usrpwretries) {
 ...
 echo " </div>";
    ...
    echo "<div class = 'mt-5'>
    <p class = 'fs-4 text-muted' >Departmental Access</p>
    </div>";
...
echo "</div>";
    ...
    echo "
    <div class = 'mt-5'>
    <p class = 'fs-4 text-muted' >Module Permissions</p>
    </div>";
    ...
    <p class = 'fw-bold fs-3 text-center'>Directory</p>
    </div>";
...
<?php
   ...
   <a href=\"mngadmusers.php?loginid=$loginid\" class='btn btn-default' role='button'>Back</a>
    <button type=\"submit\" class = 'btn mainbtnclr rounded-3 text-white' value=\"Save\">Save</button>
    </div></form>";
