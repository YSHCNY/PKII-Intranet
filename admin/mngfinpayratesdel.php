...
if($found == 1) {
  ...
  if($accesslevel >= 3 && $accesslevel <= 5) {
		// insert new record
    $res11query=""; $result11="";
    $res11query="DELETE FROM tblemppayrollctg WHERE idemppayrollctg=$idemppayrollctg";
    ...
    $adminlogdetails = "$loginid:$adminuid16 - deleted item emppayroll fixed value category with id:$idemppayrollctg";
