...
//20240731
$flexitime = (isset($_POST['flexitime'])) ? $_POST['flexitime'] :'';
...
if($loginid != "") {
     include("logincheck.php");
		...
		$res1234query="UPDATE tblemployee
						SET vacation = '$vlbal',
							sick = '$slbal',
							paternity = '$paterbal',
							maternityn = '$maternbal',
							maternityc = '$matercbal',
							special = '$splbal'
						WHERE employeeid = '$employeeid';";
		$result1234=$dbh2->query($res1234query);
...
if($found == 1) {
	...
	exit;
	// echo "<p>vartest $adminlogdetails<br>idpg:$idtblhrtapaygrp,pgn:$paygroupname14,dateanv:$date_hired21|$datehiredstartfin|$datehiredendfin,gender:$contact_gender21,vlb:$vlbal,slb:$slbal,splb:$splbal,ptrb:$paterbal,mtrnb:$maternbal,mtrcb:$matercbal,flexi:$flexitime<br>$res11query</p>";
