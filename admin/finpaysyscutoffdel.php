...
$idhrtacutoff = (isset($_GET['idhrtacutoff'])) ? $_GET['idhrtacutoff'] :'';
$idhrtapaygrp = (isset($_GET['idhrtapaygrp'])) ? $_GET['idhrtapaygrp'] :'';
...
// start contents here
	...
	$res13query="DELETE FROM tblemppayroll WHERE fk_idhrtacutoff='$idhrtacutoff' AND fk_idhrtapaygrp = '$idhrtapaygrp' AND cut_start = '$cutstart' AND cut_end = '$cutend'";
	$result13=$dbh2->query($res13query);

	$res14query="DELETE FROM tblfinpayprocsupprec WHERE fk_idhrtacutoff='$idhrtacutoff' AND fk_idhrtapaygrp = '$idhrtapaygrp' AND cutstart = '$cutstart' AND cutend = '$cutend'";
	$result14=$dbh2->query($res14query);
