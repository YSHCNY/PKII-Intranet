...
<div class="p-5  <?php echo $hero ?>">
	<div class="text-center"><h3 class = 'mb-5 mt-2 py-5 fw-bold text-uppercase  text-white'>Time Logs</h3></div>
	

	<div class="container">	
		<div class="mx-auto <?php echo $mainbg?> rounded shadow ">
			<div class = 'p-4'>
							<?php 
						...
						if($att_userid0 != "") {
							...
							<?php
									echo "<p class = 'mb-5 text-center $subtext fs-5 '>Time Log Summary for: <span class = 'fw-bold $maintext fs-4'>$name_last0, $name_first0 $name_middle0[0]</span>  </p>";
									echo "<form action=\"vtimelog.php?lst=1&lid=$loginid&sess=$session&p=12\" method=\"POST\" >";				
									include("../m/qrytimelog2.php");
									echo "<button class=\"btn btn-primary $maintext mx-2 rounded   rounded\" id='btnActdtlSubmit'>Submit</button>";
						?>
						</div></div>
						</form>
					</div>
...
if ($yyyymm != "") {
	...
	echo "<h3 class = '$maintext'>" . date("F Y", strtotime($startDate)) . "</h3>";
	echo "</div>";
	echo "<div class = 'container'>";
    echo "<div class='calendar-container  shadow p-5 rounded $mainbg d-flex justify-content-center justify-content-md-start'>";
...
?>	
        ...
        <div class="calendar-day  border <?php echo $borderClass; ?> <?php echo ($dayOfWeek == "Sunday") ? 'text-danger' : $subtext; ?> p-4">
		<div class="row">
           ...
           <div class = " text-center mt-2 mb-3">
            ...
            <div class="time calendarbg p-2 rounded ">
