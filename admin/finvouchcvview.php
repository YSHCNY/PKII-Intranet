...
*/
	...
	echo "<tr>";
        echo "<td align=\"left\" class='table-bordered'>$preparedlbl19&nbsp;$prepared19</td>";
        echo "<td colspan=\"2\" align=\"center\" class='table-bordered'>$approvedlbl19</td>";
        echo "</tr>";
	...
	// echo "<tr><td colspan=\"2\">&nbsp;</td></tr>";
        echo "<tr>";
        echo "<td align=\"left\" class='table-bordered'>$checkedlbl19&nbsp;$checked19</td>";
        echo "<td colspan='2' class='table-bordered'></td>";
        echo "</tr>";
        // 20220923 insert last line for Recommending Approval
        echo "<tr>";
        echo "<td align=\"left\" class='table-bordered'>Recommending Approval: ____________________<br>&nbsp;</td>";
        echo "<td align=\"center\" class='table-bordered'>____________________<br>&nbsp;</td>";
        echo "<td align=\"center\" class='table-bordered'>____________________<br>&nbsp;</td>";
        echo "</tr>";
	  echo "</tbody>";
	  echo "</div>";
