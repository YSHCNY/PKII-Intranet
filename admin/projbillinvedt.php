...
// compute total invoice amount
	...
	// echo "</td></tr>";
	echo "<tr><th class='text-right'>Reimbursable</th><td>";
	echo "<input type='number' step='0.01' name='contractinvoice_revised_reimb_amt' value='$contractinvoice_revised_reimb_amt11'>";
	echo "</td></tr>";
...
// compute total invoice amount
    ...
    $contractinvoice_revised_totinv_amt=$contractinvoice_revised_inv_amt11+$contractinvoice_revised_reimb_amt11+$contractinvoice_revised_vat_amt11;
	  echo "<tr><th class='text-right'>Total Invoice Amount</th><th class='text-right'>";
