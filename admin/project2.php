...
if ($found == 1)
{
	 ...
	 echo "<p>PKII Projects Listing</p>";
	echo"<a href = 'addproject.php?loginid=$loginid'> Add New Project</a>";
	...
	echo "<table class = 'table-hover table-striped' id = 'project2' style='width:100%'>";
