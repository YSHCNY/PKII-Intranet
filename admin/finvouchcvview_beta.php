...
if($cvnumber0 != '')
{
  $result15 = mysql_query("SELECT disbursementnumber, disbursementtype, payee, date, companyid, contactid FROM tblfindisbursement WHERE disbursementnumber = \"$cvnumber0\"", $dbh);
...
//	echo "<td>$projcode17 - $particulars17</td><td align=\"right\">".number_format($debitamt17,2)."</td><td align=\"right\">".number_format($creditamt17,2)."</td>";
	...
	echo "</tr>";
      ...
      echo "<tr><td><i>$explanation16</i></td><td>&nbsp;</td><td>&nbsp;</td></tr>";
	  echo "<tr><td><i>$explanation16</i></td><td>&nbsp;</td><td>&nbsp;</td></tr>";
	...
	echo "<table class=\"fin\" border=\"0\" width=\"100%\">";
		...
		echo "<table width=\"100%\" border=\"0\" spacing=\"0\" cellspacing=\"0\" cellpadding=\"0\">";
			...
			echo "<tr><td align=\"center\">$cvapproved121<br>$cvapproved1pos21</td><td align=\"center\"><b><u>$cvapproved221</u></b><br>$cvapproved2pos21</td></tr>";
		echo "</table>";
		echo "</div>";
		echo "</td></tr>";

    echo "<tr><td colspan=\"2\">";
	echo "<div class=\"page_break\"><table width=\"100%\" border=\"1\" spacing=\"0\" cellspacing=\"0\" cellpadding=\"0\">RECEIVED FROM PKII CHECK NO. <b><u>$cvnumber15</b></u><br>";
    ...
    echo " Pesos Only</u>&nbsp;<u>(P".number_format($creditamt22, 2).")</u></b></td></tr>"; 
...
else
{
  ...
  while($myrow16 = mysql_fetch_row($result16))
  {
    ...
    echo "<textarea rows=\"3\" cols=\"40\" name=\"explanation\" readonly>$explanation</textarea></td></tr>";
    echo "<tr><td colspan=\"2\" align=\"center\"><form method=\"post\">";
