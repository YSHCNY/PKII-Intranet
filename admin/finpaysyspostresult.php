<?php
//
// finpaysyspostresult.php on 20250115
...
// start contents here...
  ...
  if($accesslevel >= 3) {
	...
	<h4 class = 'm-4'>Payroll Summary Result</h4>";
  ...
  echo "";
	...
	echo "";
	//
	// display payroll summary of personnel based on selected cutoff period
	include("finpaysyspostresult2.php");
	} // if($idpaygroup != "" && $idcutoff != "")
    echo "";
