...
require '../includes/dbh.php';
	...
	$res18bquery="SELECT tblitsupportapprover.iditsupportapprover, tblitsupportapprover.approver1empid, tblitsupportapprover.approver2empid, tblitsupportapprover.approver3empid FROM tblitsupportapprover WHERE tblitsupportapprover.deptcd=\"$deptcd16\" LIMIT 1";
	...
	if($result18b->num_rows>0) {
		...
		$approver3empid18b = $myrow18b['approver3empid'];
		} // while
	} // if
