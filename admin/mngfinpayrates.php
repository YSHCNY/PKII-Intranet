...
<?php
      ...
      echo "<div class='form-group'><input type=\"text\" name=\"code\" class='form-control'></div>";
      echo "</td></tr>";
      echo "<tr><th colspan=\"2\" class='text-right'>name</th><td colspan=\"3\">";
      echo "<div class='form-group'><input type=\"text\" size=\"50\" name=\"name\" class='form-control'></div>";
      echo "</td></tr>";
      echo "<tr><th colspan=\"2\" class='text-right'>rate</th><td colspan=\"3\">";
      echo "<div class='form-group'><input name=\"amount\" value=\"0.00\" class='form-control'></div>";
      echo "</td></tr>";
      echo "<tr><th colspan=\"2\" class='text-right'>remarks</th><td colspan=\"3\">";
      echo "<div class='form-group'><textarea rows=\"3\" cols=\"50\" name=\"remarks\" class='form-control'></textarea></div>";
      echo "</td></tr>";
      ...
      echo "</form>";
      // display headers
      echo "<tr><th>code</th><th>name</th><th>rates</th><th>remarks</th><th colspan='2'>action</th></tr>";
      ...
      if($result11->num_rows>0) {
        ...
        echo "<tr><td>$code11</td><td>$name11</td><td class='text-center'>$amount11</td><td>$remarks11</td>";
        echo "<td class='text-center'><button class=\"btn btn-warning\"><a href=\"mngfinpayratesedit.php?loginid=$loginid&idctg=$idemppayrollctg11\">Edit</a></button></td>";
        echo "<td class='text-center'><button class=\"btn btn-danger\"><a href=\"mngfinpayratesdel.php?loginid=$loginid&idctg=$idemppayrollctg11\">Del</a></button></td>";
        echo "</tr>";
        } // while
      } // if
...
// edit body-footer
    echo "<p><a href=\"./mngfinmods.php?loginid=$loginid\" class='btn btn-default' role='button'>Back</a></p>";
