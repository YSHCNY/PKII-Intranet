...
?>
	<div class=" p-5 <?php echo $hero?>" >
     <div class="text-center"><h3 class = 'mb-5 mt-2 py-5 fw-bold text-uppercase text-white'>training materials</h3></div>
          </div>
...
<div class=" mx-5 pb-5 shadow border <?php echo $mainbg?> rounded">
...
<?php
	...
	foreach ($dirArray as $value0) {
		...
		echo "<div class='card-header $mainbg border-0 p-3 my-5 text-center'> 
          <p class = 'fs-3 mb-0 $maintext fw-medium'>NK Engineers Railway Course Training Materials </p>
          <p class ='fs-5 $subtext '>$value0</p>
...
<div class="card-body">
 ...
 <nav>
  ...
  <button class="nav-item nav-link <?php echo $maintext?> fs-4 "  id="v-pills-folder1-tab" data-toggle="pill" href="#v-pills-folder1" role="tab" aria-controls="v-pills-folder1" aria-selected="true">Presentation </button>
  <button class="nav-item nav-link <?php echo $maintext?> fs-4 "  id="v-pills-subfolder-tab" data-toggle="pill" href="#v-pills-subfolder" role="tab" aria-controls="v-pills-subfolder" aria-selected="false">More</button>
</div>
</nav>
  ...
  <div class="tab-pane fade " id="v-pills-folder1" role="tabpanel" aria-labelledby="v-pills-folder1-tab">
    ...
    ?>
      <div class="col-md-12 my-4">
        <p class='<?php echo $maintext?> mb-0  fw-bold '><?php echo "$valued1"; ?></p>
        <p class = '<?php echo $subtext?> fs-5'> Video of Guide And Training Materials from meetings. <span class = 'text-primary fst-italic fs-6'>(Click Cards)</span></p>
      </div>
    <?php
    }
    ?>
...
<?php
  ...
  <div class="col-md-12 my-4">
        <p class='<?php echo $maintext?> mb-0  fw-bold '>Training Materials</p>
        <p class = '<?php echo $subtext?> fs-5'> More Guide and Training Materials from meetings <span class = 'text-primary fst-italic fs-6'>(Click Cards)</span></p>
      </div>
    <?php
    ...
    ?>
        ...
        <p class='<?php echo $subtext?> fst-italic text-end fs-5 mb-0 py-2 px-4'> <?php echo "$valued2"; ?></p>
