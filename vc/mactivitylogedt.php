...
<br><br><br>
	<div class="container ">
		<div class="border my-5  mx-3 rounded-4 bg-white shadow p-5">
			...
			<form method = 'POST' action = 'mactivitylogedt2.php?lst=1&lid=<?php echo $loginid?>&sess=<?php echo $session ?>&p=143'>
	...
	<div class = 'mt-4'>
	<p class="text-muted fs-5 mb-0">Listed Projects Today:</p>
	<p class="fs-6 text-danger mb-3">Note: Please feel free to adjust the list of projects as needed. You may remove existing projects, add new ones, or retain the current projects while adding additional ones.</p>

	<div class="form-group">
	<textarea name="currproj" id = 'currproj' class = 'form-control'><?php echo $projcode16?></textarea>
	</div>

	<div class="form-group">
	<p class="text-muted fs-5 mt-3 mb-1">Add New Project</p>
    <select class="form-control" name="prjcd" id='prjcd'>
	<option value="">-</option>
		<?php
				...
				<p class = 'submaintext'>Time started</p>
						...
						<!-- <input type="time" size="8" class="form-control" name="timestart" id='tmstart' value="<?php // echo $tmstart; ?>"> -->
								<?php
									...
									echo "<input type='time' class='form-control' name=\"tmstart\" value=\"$timestart16fin\" id='tmstart'>";
			...
			<div class="col">
				<div>
							...
							<?php
								...
								echo "<input type='time' class='form-control' name=\"tmend\" value=\"$timeend16fin\" id='tmend'>";
...
echo "<a class=\"btn btn-danger text-white mx-2\" href = 'index.php?lst=1&lid=$loginid&sess=$session&p=14' >Cancel</a>";
	...
	echo "<button class=\"btn btn-success mx-2\" type = 'submit'  id='btnActdtlSubmit'>Submit</button>";
