...
//	echo "<p>Date hired changed for: <b>$pid - $name_last, $name_first $name_middle[0]</b></p>";

	$result = mysql_query("UPDATE tblemployee SET date_hired = \"$datehired\"
		WHERE employeeid=\"$pid\"", $dbh) or die ("Couldn't execute query.".mysql_error());

//	echo "date_hired = $datehired<br>";
...
//  echo "<p>";
  	...
  	$result16 = mysql_query("SELECT adminuid FROM tbladminlogin WHERE adminloginid=$loginid", $dbh);
		...
		{ $adminuid=$myrow16[0]; }
		$adminlogdetails = "$loginid:$adminuid - change date hired to $datehired for employee: $employeeid - $name_last, $name_first $name_middle";
