...
/*    } elseif(!preg_match("#[a-z]+#",$cnewpass)) {
	...
	include 'vnotif.php';
					...
					$subject = 'Hello! ' . $username . ' Change of password Email ' ;
				...
				.container{
					...
					padding: 5px 40px 5px 40px ;
							...
							<p><a href='intranet.philkoei.com.ph'>Intranet</a> or email directly at <a href='mailto:support@philkoei.com.ph'>support@philkoei.com.ph</a></p>
						</div>
							</body>
				</html>
					";
