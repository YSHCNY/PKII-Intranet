...
<?php
// start contents here
    echo "<form action=\"finrptcshdisbbk.php?loginid=$loginid\" method=\"post\" class = '' name=\"finrptcshdisbbk\"><div class=''><div class='d-flex justify-content-center gap-3'>";
	
    echo "<select name=\"yrmonthavlbl\" class='bg-white border border-dark'>";
	...
	echo "<a href=\"#\" class = 'btn btn-success' id=\"exportToExcel\">Excel</a>";
	echo "</div></div></form>";
	
 
    echo "<table id=\"ReportTable\" class='table-striped table-bordered table-hover'>";
	
	echo "<tr>";
		echo "<th colspan=\"23\" class='fs-3 fw-bold mb-0'>Philkoei International, Inc.</th>";
	echo "</tr>";
	echo "<tr>";
		echo "<th colspan=\"23\" class='fs-4 text-muted'><i>Cash Disbursement Book</i></th>";
	echo "</tr>";
	
	
		echo "<tr><th colspan=\"23\" align=\"left\">For the month of $yrmonthavlbl </th></tr>";
