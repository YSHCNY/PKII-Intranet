...
$cvdate = mysql_real_escape_string(trim((isset($_POST['cvdate'])) ? $_POST['cvdate'] :''));
$cvnumber = mysql_real_escape_string(trim((isset($_POST['cvnumber'])) ? $_POST['cvnumber'] :''));
...
$glcode = mysql_real_escape_string(trim((isset($_POST['glcode'])) ? $_POST['glcode'] :''));
$aepglcode = mysql_real_escape_string(trim((isset($_POST['aepglcode'])) ? $_POST['aepglcode'] :''));
$glnamedetails = trim((isset($_POST['glnamedetails'])) ? $_POST['glnamedetails'] :'');
$glnamedetails = mysql_real_escape_string($glnamedetails);
$projcode = mysql_real_escape_string(trim((isset($_POST['projcode'])) ? $_POST['projcode'] :''));
$particulars = mysql_real_escape_string(trim((isset($_POST['particulars'])) ? $_POST['particulars'] :''));
$debitamt = trim((isset($_POST['debitamt'])) ? $_POST['debitamt'] :'');
$creditamt = trim((isset($_POST['creditamt'])) ? $_POST['creditamt'] :'');
