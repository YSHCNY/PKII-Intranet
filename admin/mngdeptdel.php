...
//	if(($deptcd != "") && ($deptname != "")) {
	...
	$result11 = mysql_query("SELECT iddeptcd, code, name, remarks FROM tbldeptcd WHERE iddeptcd=$iddeptcd", $dbh);
	if($result11 != "") {
	...
	*/
	...
	// insert records to tbldeptcd
	$result14 = mysql_query("DELETE FROM tbldeptcd WHERE iddeptcd=$iddeptcd", $dbh);
    ...
    { $adminuid=$myrow16[0]; }
    $adminlogdetails = "$loginid:$adminuid - Deleted department in Manage Categories - Department id:$iddeptcd11 code:$deptcd11 name:$deptname11";
