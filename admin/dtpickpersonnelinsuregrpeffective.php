...
// start year of "effective date"
     echo "<input name=effectyear size=4 value=\"$effectyear\">";

// start month of "effective date"
     if ($effectmonth == "01") { $seleffectmm01 = "selected"; }
	else if ($effectmonth == "02") { $seleffectmm02 = "selected"; }
	else if ($effectmonth == "03") { $seleffectmm03 = "selected"; }
	else if ($effectmonth == "04") { $seleffectmm04 = "selected"; }
	else if ($effectmonth == "05") { $seleffectmm05 = "selected"; }
	else if ($effectmonth == "06") { $seleffectmm06 = "selected"; }
	else if ($effectmonth == "07") { $seleffectmm07 = "selected"; }
	else if ($effectmonth == "08") { $seleffectmm08 = "selected"; }
	else if ($effectmonth == "09") { $seleffectmm09 = "selected"; }
	else if ($effectmonth == "10") { $seleffectmm10 = "selected"; }
	else if ($effectmonth == "11") { $seleffectmm11 = "selected"; }
	else if ($effectmonth == "12") { $seleffectmm12 = "selected"; }
...
// start day of "effective date"
     if ($effectday == "01") { $seleffectdd01 = "selected"; }
	else if ($effectday == "02") { $seleffectdd02 = "selected"; }
	else if ($effectday == "03") { $seleffectdd03 = "selected"; }
	else if ($effectday == "04") { $seleffectdd04 = "selected"; }
	else if ($effectday == "05") { $seleffectdd05 = "selected"; }
	else if ($effectday == "06") { $seleffectdd06 = "selected"; }
	else if ($effectday == "07") { $seleffectdd07 = "selected"; }
	else if ($effectday == "08") { $seleffectdd08 = "selected"; }
	else if ($effectday == "09") { $seleffectdd09 = "selected"; }
	else if ($effectday == "10") { $seleffectdd10 = "selected"; }
	else if ($effectday == "11") { $seleffectdd11 = "selected"; }
	else if ($effectday == "12") { $seleffectdd12 = "selected"; }
	else if ($effectday == "13") { $seleffectdd13 = "selected"; }
	else if ($effectday == "14") { $seleffectdd14 = "selected"; }
	else if ($effectday == "15") { $seleffectdd15 = "selected"; }
	else if ($effectday == "16") { $seleffectdd16 = "selected"; }
	else if ($effectday == "17") { $seleffectdd17 = "selected"; }
	else if ($effectday == "18") { $seleffectdd18 = "selected"; }
	else if ($effectday == "19") { $seleffectdd19 = "selected"; }
	else if ($effectday == "20") { $seleffectdd20 = "selected"; }
	else if ($effectday == "21") { $seleffectdd21 = "selected"; }
	else if ($effectday == "22") { $seleffectdd22 = "selected"; }
	else if ($effectday == "23") { $seleffectdd23 = "selected"; }
	else if ($effectday == "24") { $seleffectdd24 = "selected"; }
	else if ($effectday == "25") { $seleffectdd25 = "selected"; }
	else if ($effectday == "26") { $seleffectdd26 = "selected"; }
	else if ($effectday == "27") { $seleffectdd27 = "selected"; }
	else if ($effectday == "28") { $seleffectdd28 = "selected"; }
	else if ($effectday == "29") { $seleffectdd29 = "selected"; }
	else if ($effectday == "30") { $seleffectdd30 = "selected"; }
	else if ($effectday == "31") { $seleffectdd31 = "selected"; }
