...
if ($found == 1)
{
	...
	echo "<tr><td colspan=2><font color=red>Warning: No employee number for this record. Please assign one. Thank you.</font></td></tr>";
	echo "<tr><td>Employee No.</td><td><input name=employeeidnew></td></tr>";
	echo "<tr><td>Full Name</td><td>$name_last, $name_first $name_middle</td></tr>";
...
//	end ecola2
	...
	echo "<tr><td>Total Duration</td><td><font size=1><i>tmp.value</i></font><br><input name=durationtotal value=\"$durationtotal\"><br>";
	echo "<table border=0 spacing=0><tr><td><input name=durationtotal_fin value=\"$durationtotal_fin\"><br><font size=1>Final value:</font></td>";
	echo "<td><input name=durationtotprop value=\"$durationtotprop\"><br><font size=1>Property:</font></td></tr></table>";
...
// start project assignments
	...
	echo "<tr><td>Employee No.</td><td><input name=employeeidnew2 value=\"$employeeid1\"></td></tr>";
	echo "<tr><td>Date</td><td>";
	echo "$projdate";
//	if ($projdate == '')
//	{ echo "Blank <a href=personnelprojassignchgprojdate.php?loginid=$loginid&eid=$employeeid&prjid=$projassignid&pdate=$projdate>Change</a>"; }
