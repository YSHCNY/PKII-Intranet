...
$file9="code_of_conduct_englishsm.pdf"; //20250527
...
// 20241223
$file17 = "DataPrivacyManual2025JanV01.PDF";
$file18 = "PKII_InfoSecPolGL_V2.01.PDF";
$file19 = "ICP_Summary_en.pdf"; //20250527
?>
<div class=" p-5 <?php echo $hero?>" >
		<div class="text-center"><h3 class = 'mb-5 mt-2 py-5 fw-bold text-uppercase text-white'>guides & policies</h3></div>
		</div>
...
<ul id="myTabs" class="nav nav-tabs border-0  text-center justify-content-center align-items-center mx-auto flex" role="tablist">
    <li role="presentation" class="dropdown rounded  ">
        <a class="dropdown-toggle border btn btn-primary  rounded " data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">Select to display content</a>
        <ul class="dropdown-menu ">
			...
			<li role="presentation"><a href="#pkdataprivman" id="pkdataprivman-tab" class ='fs-5' role="tab" data-toggle="tab" aria-controls="pkdataprivman" aria-expanded="false">Data Privacy Manual</a></li>
			<li role="presentation"><a href="#pkinfosecgl" id="pkinfosecgl-tab" class ='fs-5' role="tab" data-toggle="tab" aria-controls="pkinfosecgl" aria-expanded="false">Information Security Policy & Guidelines</a></li>
			<li role="presentation"><a href="#ideicp" id="ideicp-tab" class ='fs-5' role="tab" data-toggle="tab" aria-controls="ideicp" aria-expanded="false">ID&E's Integrity Compliance Program</a></li>
...
<!-- 20241223 Data Privacy Manual -->
	<div role="tabpanel" class="tab-pane fade" id="pkdataprivman" aria-labelledby="pkdataprivman-tab">
	<p class = "text-white text-center fs-4">Data Privacy Manual</p>
	   <div class="embed-responsive embed-responsive-16by9"> 
<?php
	if($file17!='') {
	echo "<!--[if IE]>";
...
<!-- 20241223 Information Security Policy & Guidelines -->
	<div role="tabpanel" class="tab-pane fade" id="pkinfosecgl" aria-labelledby="pkinfosecgl-tab">
	<p class = "text-white text-center fs-4">Information Security Policy & Guidelines</p>
	   <div class="embed-responsive embed-responsive-16by9"> 
<?php
	if($file17!='') {
	echo "<!--[if IE]>";
	echo "<iframe frameborder=\"0\" height=\"600\" src=\"$filepath3/$file18?wmode=opaque\" type=\"application/pdf\" width=\"900\">";
	echo "</iframe>";
	echo "<![endif]-->";

	echo "<![if !IE]>";
	echo "<object data=\"$filepath3/$file18#toolbar=0\" type=\"application/pdf\" WIDTH=\"900\" HEIGHT=\"600\">";
  echo "<param name=\"WMode\" value=\"transparent\" /></param>";
  echo "<embed src=\"$filepath3/$file18#toolbar=0\" wmode=\"transparent\" type=\"application/pdf\" />";
...
<!-- 20250527 ID&E's Integrity Compliance Program -->
	<div role="tabpanel" class="tab-pane fade" id="ideicp" aria-labelledby="ideicp-tab">
	<p class = "text-white text-center fs-4">ID&E's Integrity Compliance Program</p>
	   <div class="embed-responsive embed-responsive-16by9"> 
<?php
	if($file19!='') {
	echo "<!--[if IE]>";
	echo "<iframe frameborder=\"0\" height=\"600\" src=\"$filepath3/$file19?wmode=opaque\" type=\"application/pdf\" width=\"900\">";
	echo "</iframe>";
	echo "<![endif]-->";

	echo "<![if !IE]>";
	echo "<object data=\"$filepath3/$file19#toolbar=0\" type=\"application/pdf\" WIDTH=\"900\" HEIGHT=\"600\">";
  echo "<param name=\"WMode\" value=\"transparent\" /></param>";
  echo "<embed src=\"$filepath3/$file19#toolbar=0\" wmode=\"transparent\" type=\"application/pdf\" />";
