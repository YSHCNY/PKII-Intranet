...
//    $cashreceiptnumber11 = $myrow11[0];
  ...
  echo "<tr><td colspan=\"2\" align=\"center\"><font color=\"red\"><b>Deleting C.R. record.</td></tr>";
  ...
  {
    echo "<form method=\"post\" action=\"finvouchcrvdel2.php?loginid=$loginid&crvn=$cashreceiptnumber\">";
    echo "<input type=\"submit\" value=\"Yes\"></form>";
  }

  echo "</td>";
  echo "<td align=\"center\"><form method=\"post\" action=\"finvouchlist.php?loginid=$loginid&rs=cr\">";
