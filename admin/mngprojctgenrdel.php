...
if($idprojctgenr!='') {
	...
	$res11query="SELECT code, name_e, name_j, seq FROM tblprojctgenr WHERE idprojctgenr='$idprojctgenr'";
	...
	if($found11==1) {
	//proceed
	$res12query="DELETE FROM tblprojctgenr WHERE idprojctgenr=$idprojctgenr";
	$result12=$dbh2->query($res12query);
	// log
	$logdetails="Deleted a category of Proj ENR in tblprojctgenr. id:$idprojctgenr code:$code11 name_e:$name_e11 seq:$seq11";
