...
// start contents here...
  ...
  echo "</td></tr>";
	...
	*/
	...
	echo "</tr>";
	$res11query = "SELECT tblempdetails.empdepartment, tblempdetails.empposition, tbldeptcd.name FROM tblempdetails INNER JOIN tbldeptcd ON tblempdetails.empdepartment=tbldeptcd.code WHERE tblempdetails.employeeid=\"$employeeid\"";
	$result11=""; $found11=0; $ctr11=0;
	/*
	$result11 = mysql_query("", $dbh);
	if($result11 != "") {
	...
	*/
	...
	// row3
	echo "<tr>";
	echo "<td align=\"right\">Position:</td><th align=\"left\">$empposition11</th>";
	...
	*/
	...
	// modified 20161114
	echo "<td align=\"right\"></td><th align=\"left\">";
	echo "</th>";
	echo "</tr>";
	...
	echo "<td align=\"right\">Shift category</td><th align=\"left\">";
	$res16query = "SELECT idhrtapayshiftctg, shiftin, shiftout FROM tblhrtapayshiftctg ORDER BY shiftin ASC";
...
echo "<td align=\"right\">Rest day</td><td align=\"left\">";
