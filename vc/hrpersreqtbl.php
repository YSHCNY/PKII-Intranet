...
if($logintype==1) {
	if($dispsumm==1) {
		...
		echo "<td><button type=\"submit\" class=\"secondarybgc px-3 py-2 rounded-3 border-0 text-white\" value=\"Details\">Details</button></td>";
		echo "</form>";
	} else {
		echo "<td></td>";
	} // if($dispsumm==1)
	...
	echo "<input type=\"hidden\" name=\"idpr\" value=\"".$idhrpersreq11Arr[$x11]."\">";
		echo "<td><button type=\"submit\" class=\"secondarybgc px-3 py-2 rounded-3 borded-0 text-white\" value=\"Details\">Details</button></td>";
	echo "</form>";
} // if($logintyp==1)
