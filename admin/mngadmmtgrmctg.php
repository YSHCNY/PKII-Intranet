...
// edit body-header
     echo "<p><font size=1>Manage >> Categories >> PKII C.O. Meeting rooms</font></p>";
...
// start contents here...
  if($accesslevel >= 4) {
    ...
    echo "<table class=\"table table-striped\">";
		echo "<thead>";
    echo "<tr><th colspan=\"4\">Manage Categories - PKII C.O. Meeting rooms</th></tr>";
		echo "</thead>";
		echo "<tbody>";
		echo "<form action=\"mngadmmtgrmctgadd.php?loginid=$loginid\" method=\"POST\" name=\"mngadmmtgrmctgadd\">";
		...
		$res11query="SELECT idadmctgmtgrm, code, name, `description`, remarks,filepath, filename FROM tbladmctgmtgrm ORDER BY code ASC";
		...
		if($result11->num_rows>0) {
			...
			echo "<td><a href='mngadmmtgrmctgedt.php?loginid=$loginid&idmr=$idadmctgmtgrm11' class='btn btn-warning'>Edit</a>";
			echo "&nbsp;";
			echo "<a href='mngadmmtgrmctgdel.php?loginid=$loginid&idmr=$idadmctgmtgrm11' class='btn btn-danger'>Del</a></td>";
			echo "</tr>";
			} // while
		} // if
		echo "</tbody>";
