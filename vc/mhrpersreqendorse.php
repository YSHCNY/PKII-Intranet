...
<?php
	...
	echo "<option value=\"$recoappricgempid15|icg\">$name_last12, $name_first12 $name_middle12[0]</option>";
	echo "<option value=\"$recoapprdcgempid15|dcg\">$name_last14, $name_first14 $name_middle14[0]</option>";
	echo "</select>";
?>
	</div>
