...
// start contents here...
  ...
  echo "<tr><td colspan=\"2\">";
	...
	echo "<tr>";
		echo "<form action=\"hrtimeattincomelst.php?loginid=$loginid\" method=\"post\" name=\"modhrtaindivinfo\">";
  ...
  echo "</td></tr>";
	...
	if($idpaygroup != "") {
		$res12query = "SELECT DISTINCT tblhrtaempincome.employeeid, tblcontact.name_last, tblcontact.name_first, tblcontact.name_middle FROM tblhrtaempincome LEFT JOIN tblcontact ON tblhrtaempincome.employeeid=tblcontact.employeeid WHERE tblhrtaempincome.idpaygroup=$idpaygroup AND tblcontact.contact_type=\"personnel\" ORDER BY tblcontact.name_last ASC, tblcontact.name_first ASC";
		$result12=""; $found12=0;
