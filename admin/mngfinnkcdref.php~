...
// edit body-header
  ...
  echo "<tr><th colspan=\"8\">Account Codes</th></tr>";

// start contents here...

  echo "<tr><td colspan=\"8\" align=\"center\">";
  echo "<table width=\"100%\" border=\"0\" spacing=\"0\" cellspacing=\"0\" cellpadding=\"0\">";
  echo "<tr><td align=\"center\"><form action=\"mngfinglrefadd.php?loginid=$loginid\" method=\"post\">";
  ...
  if($ver == 1) { $select1 = "selected"; }
  else if ($ver == 2) { $select2 = "selected"; }
  echo "Version<select name=\"ver\">";
  echo "<option value=\"1\" $select1>1</option>";
  echo "<option value=\"2\" $select2>2</option>";
  echo "</select>";
  echo "<input type=\"submit\" value=\"Submit\"></form></td>";
  echo "<td align=\"center\"><td align=\"center\"><form action=\"mngfinglrefdefault.php?loginid=$loginid\" method=\"post\">";
  echo "<input type=\"submit\" value=\"Set Default Ver.\"></form></td></tr>";
  echo "</table>";
  echo "</td></tr>";
