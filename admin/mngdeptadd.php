...
if ($found == 1)
{
	...
	*/
	...
	$result14 = mysql_query("INSERT INTO tbldeptcd SET code=\"$deptcd\", name=\"$deptname\", remarks=\"$deptremarks\"", $dbh);

	// create folder for documents uploading
	// Desired folder structure
	$path = './transfers/archives/' . $deptcd;
    ...
    { $adminuid=$myrow16[0]; }
    $adminlogdetails = "$loginid:$adminuid - Add new department in Manage Categories - Department code:$deptcd name:$deptname";
