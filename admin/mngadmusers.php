...
<?php
    ...
    echo"<div class = 'col'>";
    echo "<p class = 'fs-4 text-dark mb-0 fw-bold poppins'>Admin Login</p>";
    echo "<p class = 'fs-5 text-muted poppins'>Manage admin user's login data</p>";
    echo "</div>";
...
<div class="text-end">
<button type="button" class = 'mainbtnclr px-3 py-2 border-0 text-decoration-none rounded-3 text-white poppins' data-toggle="modal" data-target="#staticBackdrop">
  + New Admin
</button>
</div>
...
<?php
   ...
   echo "<div class = 'table-responsive'>";
    echo "<table id = 'admins' class='bg-white table-striped table-hover table-bordered' style='width:100%'>";
