...
$pid = $_GET['pid'];
$emp_birthdate = $_GET['emp_birthdate'];
...
<?php
     ...
     echo "<tr><td bgcolor=blue colspan=2><font color=white><b>Change Birthdate</b></font></td></tr>";
	...
	// echo "<tr><th align=\"right\">Current Birthdate</th><td align=center>$emp_birthdate<br><font size=2><i>yyyy-mm-dd</i></font></td></tr>";
	echo "<tr><th align=\"right\">Birthdate</th>";

	echo "<form action=\"personnelchgempbirthdate2.php?loginid=$loginid&pid=$pid\" method=\"POST\" name=\"empchgbirthdate\">";
	/*
	echo "<td>";
	echo "<input name=year size=4 value=1900>";
     ...
     echo "</select></td></tr>";
		*/
	echo "<td><input type=\"date\" size=\"10\" name=\"newbirthdate\" value=\"$emp_birthdate\">";
	?>
	<a href="javascript:show_calendar('document.empchgbirthdate.newbirthdate', document.empchgbirthdate.newbirthdate.value);"><img src="./images/cal.gif" width="16" height="16" border="0" alt="Click Here to Pick up the timestamp"></a>
	<?php
	echo "</td>";
