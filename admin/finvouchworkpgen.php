...
<?php
 ...
 if($result11 != '')
 {
  while($myrow11 = mysql_fetch_row($result11))
  {
    ...
    echo "<tr><td>$cutarryear</td><td>$cutarrmonthname</td><td colspan=\"2\" align=\"center\"><a href=\"finvouchworkpgendel.php?loginid=$loginid&gd=$month11\" class='btn btn-danger btm-md' role='button'>Del</a></td></tr>";
  }
 }
