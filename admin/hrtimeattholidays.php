...
if($holidaytype == "special") { $hdtypselspecial="selected"; $hdtypsellegal=""; $hdtypselcity=""; $hdtypselshortened=""; $hdtypselall=""; $hdtypeselnone=""; }
else if($holidaytype == "legal") { $hdtypselspecial=""; $hdtypsellegal="selected"; $hdtypselcity=""; $hdtypselshortened=""; $hdtypselall=""; $hdtypeselnone=""; }
else if($holidaytype == "city") { $hdtypselspecial=""; $hdtypsellegal=""; $hdtypselcity="selected"; $hdtypselshortened=""; $hdtypselall=""; $hdtypeselnone=""; }
else if($holidaytype == "shortened") { $hdtypselspecial=""; $hdtypsellegal=""; $hdtypselcity=""; $hdtypselshortened="selected"; $hdtypselall=""; $hdtypeselnone=""; }
else if($holidaytype == "all") { $hdtypselspecial=""; $hdtypsellegal=""; $hdtypselcity=""; $hdtypselshortened=""; $hdtypselall="selected"; $hdtypeselnone=""; }
else { $hdtypselspecial=""; $hdtypsellegal=""; $hdtypselcity=""; $hdtypselshortened=""; $hdtypselall=""; $hdtypeselnone="selected"; }
...
// start contents here...
  ...
  <?php
	...
	echo "<option value=\"city\">City holiday</option>";
