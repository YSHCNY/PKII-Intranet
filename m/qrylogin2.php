...
include("../includes/genranchars.php");
    ...
    // get primary key from idloginstatus from primary key
    ...
    $res8query="SELECT tbladminlogin.adminloginid FROM tbladminlogin WHERE tbladminlogin.adminuid=\"$username\"";
