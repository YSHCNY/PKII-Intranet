<?php
//
// finpaysyspostpayslip.php on 20250115
...
// start contents here...
  ...
  if($accesslevel >= 3) {
		echo "<form action=\"finpaysyspost.php?loginid=$loginid&pg=pn&act=2\" method=\"post\" name=\"finpaysyspostpayslip\" >";
		

		// pay group name dropdown
    echo "<div class = 'row p-4 border shadow'>
	
	<h4 class = 'm-4'>Payslip E-mail Notifier</h4>";
  ...
  echo "";
	...
	echo "";
	//
	// display emails of personnel based on selected cutoff period
	include("finpaysyspostpayslip2.php");
	} // if($idpaygroup != "" && $idcutoff != "")
    echo "";
