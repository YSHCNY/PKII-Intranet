...
<ul id="myTabs" class="nav nav-tabs border-0 mb-5 text-center justify-content-center align-items-center mx-auto flex" role="tablist">
    <li role="presentation" class="dropdown rounded-3 text-center ">
        <a class="dropdown-toggle bg-white text-center rounded-3 drpdwniso" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">Select to display content</a>
        <ul class="dropdown-menu">
            <li role="presentation" class="active"><a href="#isomanual" id="isomanual-tab" role="tab" data-toggle="tab" aria-controls="isomanual" aria-expanded="true">ISO Manual</a></li>
            <li role="presentation"><a href="#isoproc" id="isoproc-tab" role="tab" data-toggle="tab" aria-controls="isoproc" aria-expanded="false">ISO Procedures</a></li>
            <li role="presentation"><a href="#isojobdesc" id="isojobdesc-tab" role="tab" data-toggle="tab" aria-controls="isojobdesc" aria-expanded="false">Job Description</a></li>
            <li role="presentation"><a href="#workinst" id="workinst-tab" role="tab" data-toggle="tab" aria-controls="workinst" aria-expanded="false">Work Instructions</a></li>
            <li role="presentation"><a href="#isoforms" id="isoforms-tab" role="tab" data-toggle="tab" aria-controls="isoforms" aria-expanded="false">Office Forms</a></li>
			<li role="presentation"><a href="#empmanual" id="empmanual-tab" role="tab" data-toggle="tab" aria-controls="empmanual" aria-expanded="false">Employees' Manual</a></li>
			<li role="presentation"><a href="#itpolicy" id="itpolicy-tab" role="tab" data-toggle="tab" aria-controls="itpolicy" aria-expanded="false">IT Policy</a></li>
			<li role="presentation"><a href="#ssemanual" id="ssemanual-tab" role="tab" data-toggle="tab" aria-controls="ssemanual" aria-expanded="false">SSE Manual</a></li>
			<li role="presentation"><a href="#nkcodeoc" id="nkcodeoc-tab" role="tab" data-toggle="tab" aria-controls="nkcodeoc" aria-expanded="false">ID&E Code of Conduct</a></li>
			<li role="presentation"><a href="#nkcorpmg" id="nkcorpmg-tab" role="tab" data-toggle="tab" aria-controls="nkcorpmg" aria-expanded="false">NK Corp. Mgmt. Guideline</a></li>
			<li role="presentation"><a href="#pkregnallocdts" id="pkregnallocdts-tab" role="tab" data-toggle="tab" aria-controls="pkregnallocdts" aria-expanded="false">Reg'n. on Allocation of Duties</a></li>
			<li role="presentation"><a href="#pkriskcrisismgtregn" id="pkriskcrisismgtregn-tab" role="tab" data-toggle="tab" aria-controls="pkriskcrisismgtregn" aria-expanded="false">Risk & Crisis Mgmt. Reg'n.</a></li>
			<li role="presentation"><a href="#pkbasicpoldevics" id="pkbasicpoldevics-tab" role="tab" data-toggle="tab" aria-controls="pkbasicpoldevics" aria-expanded="false">Basic Policies on the Dev't of Internal Control System</a></li>
			<li role="presentation"><a href="#pkiomriskrptcli" id="pkiomriskrptcli-tab" role="tab" data-toggle="tab" aria-controls="pkiomriskrptcli" aria-expanded="false">Risk Reporting to Clients</a></li>
			<li role="presentation"><a href="#pkbriberypreventregn" id="pkbriberypreventregn-tab" role="tab" data-toggle="tab" aria-controls="pkbriberypreventregn" aria-expanded="false">Bribery Prevention Reg'n.</a></li>
			<li role="presentation"><a href="#pkregnconswhistleblowing" id="pkregnconswhistleblowing-tab" role="tab" data-toggle="tab" aria-controls="pkregnconswhistleblowing" aria-expanded="false">Whistleblowing Consultation and Reporting Reg'n.</a></li>
			<li role="presentation"><a href="#pkinfosecdlp" id="pkinfosecdlp-tab" role="tab" data-toggle="tab" aria-controls="pkinfosecdlp" aria-expanded="false">Information Security Guidelines and Data Loss/Leak Prevention</a></li>
        </ul>
    </li>
...
<div id="myTabContent" class="tab-content">
	...
	<p class = "text-center p-5 border bg-white rounded-5"> 
<?php
	if($file1!='') {
	echo "<!--[if IE]>";
