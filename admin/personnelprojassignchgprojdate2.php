...
//	  $employeeid = $myrow0[0];
	...
	echo "<p>Date changed for: <b>$employeeid - $name_last, $name_first $name_middle[0]</b></p>";

	$result = mysql_query("UPDATE tblprojassign SET projdate = '$newdate'
		WHERE employeeid='$employeeid'", $dbh) or die ("Couldn't execute query.".mysql_error());

	echo "projdate = $newdate<br>";
