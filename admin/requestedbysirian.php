...
// edit body-header
     ...
     echo '<form method="post" action="requestedbysirian.php?loginid='.$loginid.'">';
     ?>
     ...
     $grandTotalDebit = 0;
        ...
        $companyid15 = '';
        $contactid15 = '';
        $subDisbursement = "SELECT * FROM tblfinjournal 
        WHERE date BETWEEN '".$fromDate."' AND '".$toDate."' AND glcode = '10.10.467'";
        ...
        while($rowDisbursement = $subDisbursementResult->fetch_assoc()) 
        {
          ...
          if($identifier != $rowDisbursement['journalnumber'])
          {
          echo "<tr>";
            echo "<td colspan='2'>Ref No: <b><u>".$rowDisbursement['journalnumber']."</b></u></td>";
            echo "<td colspan='4'>Payee: ";
		...
		$payor15b = str_replace("'", "", $payor15);
            echo "<b><u>Central Office</u></b>";
          }
          echo "</td>";
            echo "<td colspan='3'>Date: <b><u>".$rowDisbursement['date']."</b></u></td>";
...
$explanationfin = str_replace("'", "", $rowDisbursement['explanation']);
            echo "<td colspan='1'>".$rowDisbursement['journalnumber'] ."</td>";
...
$explanationfin = str_replace("'", "", $rowDisbursement['explanation']);
	...
	$particularsfin=""; $explanationfin="";            
            ...
            $identifier = $rowDisbursement['journalnumber'];
        ...
        //enddisbursement
          $allTotalDebit = $sumDisbursementDebit;
          $allTotalCredit = $sumDisbursementCredit;
