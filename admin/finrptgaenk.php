...
// edit body-header
    ...
    echo "<tr><th colspan=\"2\" align=\"left\">Nippon Koei General and Administrative Expenses&nbsp;<a href=\"#\" id=\"exportToExcel\"><img src=\"./images/sheet.gif\"></a></th></tr>";
  ...
  if(isset($_POST['fromDate'])) {
    ...
    if($result11 != "") {
      ...
      */
        ...
        $query16 = "SELECT acctspayableid, acctspayablenumber, debitamt, creditamt FROM tbljoinnkgandpkiicodes LEFT JOIN tblfinacctspayable ON tblfinacctspayable.glcode = tbljoinnkgandpkiicodes.pkiicode WHERE nkgcode=\"$gaecd11\" AND (date>=\"$fromDate\" AND date<=\"$toDate\") ORDER BY date ASC";
