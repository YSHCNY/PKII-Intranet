...
// echo "2.3<br>";
        ...
        $res15query="UPDATE tblsysusracctmgt SET skippwctr=$skippwctr2, skiplastdt=\"$skiplastdt\" WHERE idtblsysusracctmgt=$idtblsysusracctmgt14 AND loginid=$loginid AND admloginid=0 AND employeeid=\"$employeeid11\"";
