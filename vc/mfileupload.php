...
?>
	...
	<h4 class = "ms-5 py-5 text-white">File uploader</h4>
...
<!-- //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// -->
<div class="container">
	<div class="row bg-white shadow-lg p-5 mb-5 rounded-4 border  ">

	<div class="col-auto p-5 my-4 rounded-4 border mx-auto ">

	
			<div class = "my-5">
	<h4 class = "text-secondary text-center">Upload <span class = "fw-bold text-warning  text-uppercase">Private</span> file(s)</h4>
	</div>
<?php
...
?>
				<div class="row g-0 my-5">
					...
					<div class="col-md-3 py-2  "><?php echo "<input type=\"submit\" class=\"form-control form-control-lg  bg-success rounded-3 text-white fs-4 py-2 px-4   \" value=\"Upload\" />";?></div>
				</div>
		<?php
	echo "</form>";
?>
...
<div class="col-auto p-5 my-4   rounded-4   mx-auto border ">



	<div class="my-5">
<h4 class = "text-secondary text-center">Upload <span class = "fw-bold text-info text-uppercase">Public</span> file(s)</h4>
</div>
<?php
	echo "<form enctype=\"multipart/form-data\" action=\"index.php?lst=1&lid=$loginid&sess=$session&p=31\" method=\"POST\">";
	echo "<input name=\"uploadsw\" type=\"hidden\" value=\"yes\">"; 
