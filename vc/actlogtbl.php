...
<?php
	...
	echo "<input type='hidden' name='eid' value='$employeeid0'>";
		...
		if(date("D", strtotime($dateval)) == "Sun") {
			echo "<tr $actrowspan>
			<p class = 'text-muted  text-start' $actrowspan> <span class = 'fs-3 text-danger'>".date("Y-M-d", strtotime($dateval))."</span></p>
    ...
    if($found11b==1 && $yyyymmdd11b==$cutstart) {
		...
		echo "<tr $actrowspan>
		<p class = 'text-muted  text-start ' $actrowspan> <span class = 'fs-3 maintext'>".date("Y-M-d", strtotime($dateval))."</span></p>
...
$timeout15val=$timeout15Arr[$x];
			...
			echo "</span></p>"; 
						...
						echo "<p $actrowspan ></p><p $actrowspan ></p>";
                    } //if-else
                } // if-else
// ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    // 20210710 wfh column
    ...
    echo "<div class = 'text-end'><p $actrowspan class=''><span class = '$cs'>$wfhflag</span></p></div>";
...
require '../includes/dbh.php';
		...
		if($x==0 && $actrowctr>1) {
			echo "<td $actrowspan><span class = 'text-muted '>Hours Rendered: </span><input style='width: 80px !important;' class = 'px-2 border-0 bg-transparent' type='number' readonly step='any' name='timeval[]' value='$timevaldaily'><br>";
