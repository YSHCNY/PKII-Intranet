...
if($contract_id!='' && $proj_code!='') {
  ...
  echo "<tr><th class='text-right'>Remuneration</th><td>";
	...
	echo "<input type='number' step='0.01' name='contractinvoice_plan_inv_amt' value='0.00'>";
	// echo "<br>or";
  echo "</td></tr>";
	...
	echo "<input type='number' step='0.01' name='contractinvoice_plan_reimb_amt' value='0.00'>";
	echo "</td></tr>";

	echo "<tr><th class='text-right'>VAT amount</th><td>";
	// echo "<input type='radio' id='radioa3' name='invvatplanchksw' value='amount'>";
	echo "<input type='number' step='0.01' name='contractinvoice_plan_vat_amt' value='0.00'>";
	// echo "<br>or";
  echo "</td></tr>";
	...
	echo "<input type='number' step='0.01' name='contractinvoice_actl_inv_amt' value='0.00'>";
  // echo "<br>or";
	echo "</td></tr>";
	// echo "<tr><th class='text-right'>Invoice percentage</th><td>";
	...
	echo "<tr><th class='text-right'>Reimbursable</th><td>";
	echo "<input type='number' step='0.01' name='contractinvoice_actl_reimb_amt' value='0.00'>";
	echo "</td></tr>";

	echo "<tr><th class='text-right'>VAT amount</th><td>";
	// echo "<input type='radio' id='radiob3' name='invvatactlchksw' value='amount'>";
	echo "<input type='number' step='0.01' name='contractinvoice_actl_vat_amt' value='0.00'>";
  // echo "<br>or";
	echo "</td></tr>";
	// echo "<tr><th class='text-right'>VAT percentage</th><td>";
	...
	echo "<input type='number' step='0.01' name='contractinvoice_revised_inv_amt' value='0.00'>";
  // echo "<br>or";
	echo "</td></tr>";
	// echo "<tr><th class='text-right'>Invoice percentage</th><td>";
	...
	echo "<tr><th class='text-right'>Reimbursable</th><td>";
	echo "<input type='number' step='0.01' name='contractinvoice_revised_reimb_amt' value='0.00'>";
	echo "</td></tr>";

	echo "<tr><th class='text-right'>VAT amount</th><td>";
	// echo "<input type='radio' id='radioc3' name='invvatrevchksw' value='amount'>";
	echo "<input type='number' step='0.01' name='contractinvoice_revised_vat_amt' value='0.00'>";
  // echo "<br>or";
	echo "</td></tr>";
	// echo "<tr><th class='text-right'>VAT percentage</th><td>";
