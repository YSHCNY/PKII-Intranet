...
// echo "<p>f14:$found14, $name_last14, $name_first14</p>";
	...
	if($found11 == 1 && $employeeid != "" && $dateend>=$datestart) {
		...
		if ($result12 == TRUE){
			$_SESSION['success_message'] = 'Additional Allowance Added Successfully!';
			header("Location: hrtimeattincome.php?loginid=$loginid&idpg=$idpaygroup&eid=$employeeid&tab=$tab");
			

		} else {
			$_SESSION['error_message'] = 'Additional Allowance Insert Denied!';
			header("Location: hrtimeattincome.php?loginid=$loginid&idpg=$idpaygroup&eid=$employeeid&tab=$tab");
		}
		// create log
