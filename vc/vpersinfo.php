...
<div class="pe-5 ps-5 <?php echo $hero ?>">
    <div class="row justify-content-center align-items-center">
        <?php
			if($found11==1) {
        echo '<div class="col-md-12 text-center p-5 ">';
		echo "<img src=\"$pathavatar/$picfn11\" class=\"rounded-circle $maintext border border-white mt-5\" alt=\"\" height=\"200\" width=\"200\">";
		// echo "<img src=\"img/hello.jpg\" class=\"rounded-circle $maintext border border-white mt-5\" alt=\"No Image Available.\" height=\"200\" width=\"200\">";

        echo '</div>';

		echo '<div class="col-md-12 text-center">';
        echo "<h2 class = ' text-white fw-bold mb-5 pb-0 text-uppercase'>$name_first11 $name_middle11 $name_last11</h2>";
		echo '</div>';
		
		
		?>
		
			<div class="container flex pb-5 mb-5">
...
<div class="container w-100 mb-5 ">
	<div class="header-title">
		<h2 class="fs-1 text-uppercase <?php echo $maintext?> <?php echo $maintext?> fw-bold text-center">More <span class = "">Details</span></h2>
		
	</div>
    <div class="row flex-wrap g-4">
        <div class="col-lg-3 col-md-6 col-sm-12">
            <div class="card <?php echo $mainbg ?>   rounded mb-4 h-100">
                <div class="card-header <?php echo $mainbg ?> ">
                    <h4 class="text-center text-uppercase px-4 mt-5 fs-1 <?php echo $maintext ?>">Employee</h4>
                </div>
                <div class="card-body px-4 pb-4 mx-auto">
				
					<div class = 'text-center py-3'>
					<p class="<?php echo $maintext ?> mx-4 mb-0"><?php echo $date_hired11?></p>
                    <p class="fs-5 <?php echo $subtext?>">Date Hired</p>
					</div>

					<div class = 'text-center py-3'>
					<p class="<?php echo $maintext ?> mx-4 mb-0"><?php echo $emp_birthdate11?></p>
                    <p class="fs-5 <?php echo $subtext?>">Birth Date</p>
					</div>

					<div class = 'text-center py-3'>
					<p class="<?php echo $maintext ?> mx-4 mb-0"><?php echo $emp_birthplace11 ?></p>
                    <p class="fs-5 <?php echo $subtext?>">Birth Place</p>
					</div>

					<div class = 'text-center py-3'>
					<p class="<?php echo $maintext ?> mx-4 mb-0"><?php echo $emp_civilstatus11 ?></p>
                    <p class="fs-5 <?php echo $subtext?>">Civil Status</p>
					</div>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-3 col-md-6 col-sm-12">
            <div class="card <?php echo $mainbg?>  rounded mb-4 h-100" >
                <div class="card-header <?php echo $mainbg?> ">
                    <h4 class="text-center  text-uppercase px-4 mt-5 fs-1 <?php echo $maintext ?>">Other</h4>
                </div>
                <div class="card-body px-4 pb-4 mx-auto">
					<div class = 'text-center py-3'>
                   
					<p class="<?php echo $maintext ?> mx-4 mb-0"><?php echo $url11 ?></p>
					<p class="fs-5 <?php echo $subtext?> ">Website</p>
					</div>

					<div class = 'text-center py-3'>
                   
					<p class="<?php echo $maintext ?> mx-4 mb-0"><?php echo $emp_skills11?></p>
										<p class="fs-5 <?php echo $subtext?> ">Skills</p>
					</div>

					<div class = 'text-center py-3'>
					<p class="<?php echo $maintext ?> mx-4 mb-0"><?php echo $emp_status11?></p>
					                    <p class="fs-5 <?php echo $subtext?> ">Status</p>
					</div>

					<div class = 'text-center py-3'>
					<p class="<?php echo $maintext ?> mx-4 mb-0"><?php echo $emp_remarks11 ?></p>
					                    <p class="fs-5 <?php echo $subtext?> ">Remarks</p>
					</div>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-3 col-md-6 col-sm-12">
            <div class="card <?php echo $mainbg?>  rounded mb-4 h-100">
                <div class="card-header <?php echo $mainbg?> ">
                    <h4 class="text-center  text-uppercase px-4 mt-5 fs-1 <?php echo $maintext ?>">Tax</h4>
                </div>
                <div class="card-body px-4 pb-4 mx-auto">

					<div class = 'text-center py-3'>             
					<p class="<?php echo $maintext ?> mx-4 mb-0"><?php echo $emp_tin11?></p>
					<p class="fs-5 <?php echo $subtext?> ">BIR TIN</p>
					</div>

					<div class = 'text-center py-3'>
					<p  class="<?php echo $maintext ?> mx-4 mb-0"><?php echo $emp_sss11?></p>
					<p class="fs-5 <?php echo $subtext?> ">SSS</p>
					</div>


					<div class = 'text-center py-3'>
					<p  class="<?php echo $maintext ?> mx-4 mb-0"><?php echo $emp_philhealth11?></p>
					<p class="fs-5 <?php echo $subtext?> ">Philhealth</p>
					</div>

					<div class = 'text-center py-3'>
					<p  class="<?php echo $maintext ?> mx-4 mb-0"><?php echo $emp_pagibig11 ?></p>	
					<p class="fs-5 <?php echo $subtext?> ">PAGIBIG</p>
					</div>
        ...
        <div class="col-lg-3 col-md-6 col-sm-12">
            <div class="card <?php echo $mainbg?>   rounded mb-4 h-100">
                <div class="card-header <?php echo $mainbg?> ">
                    <h4 class="text-center  text-uppercase px-4 mt-5 fs-1 <?php echo $maintext ?>">Position</h4>
                </div>
                <div class="card-body px-4 pb-4 mx-auto">
					<div class = 'text-center py-3'>
					<p class="<?php echo $maintext ?> mx-4 mb-0"><?php echo $position ?></p>
                    <p class="fs-5 <?php echo $subtext?> ">Position</p>
					</div>

					<div class = 'text-center py-3'>
					<p class="<?php echo $maintext ?> mx-4 mb-0"><?php echo $department?></p>
                    <p class="fs-5 <?php echo $subtext?>">Department</p>
					</div>

					<div class = 'text-center py-3'>
					<p class="<?php echo $maintext ?> mx-4 mb-0"><?php echo $positionlevel?></p>
                    <p class="fs-5 <?php echo $subtext?>">Position Level</p>
					</div>

					<div class = 'text-center py-3'>
					<p class="<?php echo $maintext ?> mx-4 mb-0"><?php echo $salarygrade ?></p>
                    <p class="fs-5 <?php echo $subtext?>">Salary Grade</p>
					</div>
	...
	<!-- end of details card -->
        ...
        <div class="text-center">
            <h1 class="fs-1 text-uppercase <?php echo $maintext?> fw-bold text-center">My <span class = ''>Projects</span></h1>
        </div>
...
<div class="col-md-6 my-4 anyClass   p-5 " >	
	<h5  class = " m-2 <?php echo $subtext ?> fs-4">Project <span class = "">Assignments</span></h4>

	<?php

											$param11 = count($ref_noArr);
											if($param11 == 0){
												echo '<h5 class = "<?php echo $subtext?> text-center p-5">You have no projects </h5>';
											}
											else{
											for ($x11 = 0; $x11 < $param11; $x11++) {
												echo "<div class='$mainbg  rounded my-5 py-3'>";
												echo "<div class='card-body p-3'>";
												echo "<div class = '-bottom'>";
											
												echo "<p class='card-text $subtext fs-6 pb-3 my-4 text-center' >Project Name <br><span class = 'fs-3 px-2  $maintext fw-bold'>" . $proj_nameArr[$x11] . " " . $projname5aArr[$x11] . "</span></p>";
												echo "</div>";
												
												echo"<div class = 'row gap-2 gap-md-0 text-center pt-3'>";

												echo"<div class = 'col-md-6 col-sm-12 col-lg-3 my-2 '>";
												echo "<p class = '$subtext fs-6 mb-1 pb-1'>Reference</p>";
												echo "<p class='card-text'><span class = 'mainboxbg text-white fst-italic fs-5 px-3 py-1 rounded-2'>" . $ref_noArr[$x11] . "</span></p>";
												echo"</div>";

												echo"<div class = 'col-md-6 col-sm-12 col-lg-3 my-2  '>";
												echo "<p class = '$subtext fs-6 mb-1 pb-1'>Code</p>";
												...
												if ($found8 == 1) {
													echo "<p class = '$subtext fs-6 mb-0 pb-0'>Code</p>";
													echo "<p class='card-text'><span class = 'secondarybgc $maintext fs-5 px-3 py-1 rounded-2'>" . $name8Arr[$x11] . "</span></p>";
													echo"</div>";

													echo"<div class = 'col-md-6 col-sm-12 col-lg-3 my-2 '>";
												}
												} else {
												echo "<p class = '$subtext fs-6 mb-0 pb-0'>Position: </p>";
												echo "<p class='card-text'><span class = 'secondarybgc $maintext fs-5 px-3 py-1 rounded-2'>" . $positionArr[$x11] . "</span></p>";
												echo"</div>";

												echo"<div class = 'col-md-6 col-sm-12 col-lg-3 my-2 ' >";
												}
												echo "<p class = '$subtext fs-6 mb-0 pb-0'>Started</p>";
												echo "<p class='card-text'><span class = '  $maintext fst-italic fs-5 py-1 rounded-2'>" . $date_fromArr[$x11] . "</span></p>";
												echo"</div>";

												echo"<div class = 'col-md-6 col-sm-12 col-lg-3 my-2 '>";
												echo "<p class = '$subtext fs-6 mb-0 pb-0'>Ended:</p>";
												echo "<p class='card-text'><span class = '  $maintext fst-italic fs-5 py-1 rounded-2'>" . $date_toArr[$x11] . "</span></p>";
												echo"</div>";
	...
	<div class="col-md-6 my-4 anyClass  p-5">
	<h5  class = " m-2 <?php echo $subtext ?> fs-4">Temporary Project <span class = "">Assignments</span></h4>
		
								<div class="card py-5 <?php echo $mainbg ?>  my-5 ">
									<div class="card-body px-4">
										<div class = ' p-4 text-center'>

										<div class="row ">
											<div class="col-md-6">
												<p class="card-text fs-6  <?php echo $subtext ?> mb-1 pb-1">Project Name</p>
												<p class="card-text  <?php echo $maintext ?> fw-bold fs-4"><?php echo $proj_name1;?></p>
											</div>

											<div class="col-md-6">
											<p class="card-text fs-6  <?php echo $subtext ?> mb-0 pb-0">Code</p>
											<p class="card-text <?php echo $subtext ?> fs-4 py-1 rounded-2"><?php echo $proj_code1;?></p>
											</div>
										</div>
										...
										<div class="row gap-3 gap-md-0 text-center pt-3">
											...
											<p class="card-text fs-6  <?php echo $subtext ?> mb-0 pb-0">Reference No</p>
											<p scope="row" class="card-text <?php echo $maintext ?> fst-italic fs-5 py-1 rounded-2" ><?php echo $ref_no1; ?></p>
											</div>
											...
											<div class="col-md-6 col-sm-12 col-lg-3 my-2">
											<p class="card-text fs-6 <?php echo $subtext ?> mb-0 pb-0">Position</p>
											<p class="card-text <?php echo $maintext ?> fst-italic fs-5 py-1 rounded-2"><?php echo $position1;?></p>
											</div>

											<div class="col-md-6 col-sm-12 col-lg-3 my-2">
											<p class="card-text fs-6 <?php echo $subtext ?> mb-0 pb-0">Start</p>
											<p class="card-text <?php echo $maintext ?> fst-italic fs-5 py-1 rounded-2"><?php echo $durationfrom1;?></p>
											</div>

											<div class="col-md-6 col-sm-12 col-lg-3 my-2">
											<p class="card-text fs-6 <?php echo $subtext ?> mb-0 pb-0">End</p>
											<p class="card-text <?php echo $maintext ?> fst-italic fs-5 py-1 rounded-2"><?php echo $durationto1;?></p>
											</div>
...
<!-- end of temp ass -->
	...
	<h1 class="fs-1 text-uppercase <?php echo $maintext?> fw-bold text-center">Employee <span class = ''>background</span></h1>

	
										
	<div class="table-responsive-sm my-5 flex">
	<table class=" w-75 <?php echo "$tableinfo $mainbg"?>  mx-auto p-5 shadow  caption-top">
		
	<caption class = " m-2 fs-4 <?php echo $maintext?>">Insurance <span class = "">Details</span></caption>
        <thead class = 'border-bottom'>
            <tr class = 'fs-5'>
                <th scope="col" class="p-4 <?php echo $subtext?> text-center">Insurance Name</th>
                <th scope="col" class="p-4 <?php echo $subtext?> text-center">Group Policy No.</th>
                <th scope="col" class="p-4 <?php echo $subtext?> text-center">Employee Policy No.</th>
                <th scope="col" class="p-4 <?php echo $subtext?> text-center">Date Started</th>
                <th scope="col" class="p-4 <?php echo $subtext?> text-center">Current Status</th>
				<th scope="col" class="p-4 <?php echo $subtext?> text-center">Location</th>
...
<!-- end of insurance details -->
	...
	<div class="table-responsive-sm my-5 flex">
	<table class="  w-75 <?php echo "$tableinfo $mainbg"?>  mx-auto p-5 shadow  caption-top">	
	<caption class = " m-2 fs-4 <?php echo $maintext?>">Professional License <span class = "<?php echo $maintext ?>">Details</span></caption>
        <thead class = 'border-bottom' >
            <tr class = ' fs-5'>
                <th scope="col" class="p-4 <?php echo $subtext?> text-center">Regulatory Board</th>
                <th scope="col" class="p-4 <?php echo $subtext?> text-center">Profession</th>
                <th scope="col" class="p-4 <?php echo $subtext?> text-center">License Number</th>
                <th scope="col" class="p-4 <?php echo $subtext?> text-center">Date from</th>
				<th scope="col" class="p-4 <?php echo $subtext?> text-center">Date to</th>
				<th scope="col" class="p-4 <?php echo $subtext?> text-center">Location</th>
	...
	<div class="table-responsive-sm my-5 flex">
	<table class="  w-75 table-sm <?php echo "$tableinfo $mainbg"?>   mx-auto p-5 shadow  caption-top">	
	<caption class = " m-2 fs-4 <?php echo $maintext?>">Educational <span class = "<?php echo $maintext ?>">Background</span></caption>
        <thead class = 'border-bottom'>
            <tr class = ' fs-5'>
				<th scope="col" class="p-4 <?php echo $subtext?> text-center">Course</th>
                <th scope="col" class="p-4 <?php echo $subtext?> text-center">Year Graduated</th>
                <th scope="col" class="p-4 <?php echo $subtext?> text-center">University</th>
                <th scope="col" class="p-4 <?php echo $subtext?> text-center">Date</th>
	...
	<caption class = " m-2 fs-4 <?php echo $maintext?>">Bank Account <span class = "<?php echo $maintext ?>">Details</span></caption>
        <thead class = 'border-bottom'>
            <tr class = ' fs-5'>
             

				<th scope="col" class="p-4 <?php echo $subtext?> text-center">Bank Name</th>
                <th scope="col" class="p-4 <?php echo $subtext?> text-center">Branch</th>
                <th scope="col" class="p-4 <?php echo $subtext?> text-center">Account No.</th>
                <th scope="col" class="p-4 <?php echo $subtext?> text-center">Type</th>
				<th scope="col" class="p-4 <?php echo $subtext?> text-center">Currency</th>
				<th scope="col" class="p-4 <?php echo $subtext?> text-center">Account Name</th>
	...
	<caption class = " m-2 fs-4 <?php echo $maintext?>">Emergency Contact <span class = "<?php echo $maintext ?>">Information</span></caption>
        <thead class = 'border-bottom'>
            <tr class = 'fs-5' >
             

				<th scope="col" class="p-4 <?php echo $subtext?> text-center">Name</th>
                <th scope="col" class="p-4 <?php echo $subtext?> text-center">Relation</th>
                <th scope="col" class="p-4 <?php echo $subtext?> text-center">Line</th>
                <th scope="col" class="p-4 <?php echo $subtext?> text-center">Mobile</th>
				<th scope="col" class="p-4 <?php echo $subtext?> text-center">Email</th>
	...
	<caption class = " m-2 fs-4 <?php echo $maintext?>">List of <span class = "<?php echo $maintext ?>">Dependents</span></caption>
        <thead class = "border-bottom" >
            <tr class = 'fs-5' >
             

				<th scope="col" class="p-4 <?php echo $subtext?>">Name</th>
                <th scope="col" class="p-4 <?php echo $subtext?>">Birthdate</th>
                <th scope="col" class="p-4 <?php echo $subtext?>">Relation</th>
...
$res5query = "SELECT * FROM tblempdependent WHERE employeeid=$employeeid0";
$result5="";
...
if($result5->num_rows>0) {
  ...
  echo "<td class = 'p-4'>$dependentfirst $dependentmiddle $dependentlast</td>";
  echo "<td class = 'p-4'>$dependentbirthdate</td>";
  echo "<td class = 'p-4'>$dependentrelation</td></tr>";
