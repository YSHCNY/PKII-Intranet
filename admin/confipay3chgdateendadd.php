...
{
     echo "<html>";
     echo "<h2>Change End Date of Additional Income</h2>";
...
//	  $employeeid = $myrow[0];
	...
	$result1 = mysql_query("SELECT tblconfipaymemadd.confipayaddid, tblconfipaymemadd.employeeid, tblconfipaymemadd.nameadd, tblconfipaymemadd.endadd FROM tblconfipaymemadd WHERE tblconfipaymemadd.confipayaddid=$confipayaddid AND tblconfipaymemadd.employeeid='$employeeid'", $dbh);
...
//          $employeeid = $myrow1[1];
	...
	echo "<table border=1 spacing=0><tr><td>End Date</td><td align=center>$endadd<br><font size=1><i>yyyy-mm-dd</i></font></td></tr>";
	echo "<tr><td>New Date</td><td>";

	echo "<form action=\"confipay3chgdateendadd2.php?loginid=$loginid&pid=$employeeid&gn=$groupname&addid=$confipayaddid\" method=\"POST\">";
	...
	echo "<input name=year size=4 value=2010>";
     ...
     echo "<p>";
     echo "<p><a href=\"confipay3.php?eid=$employeeid&loginid=$loginid&eid=$employeeid&gn=$groupname\">Back</a><br>";
