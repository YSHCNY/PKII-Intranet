...
if ($found == 1)
{
  ...
  else
  {
	...
	$proj_sname = $myrow12[1];
     ...
     echo "<p><a href=personnelinsureempedit.php?loginid=$loginid&pid=$employeeid>Back to Edit Personnel Info</a><br>";   
...
?>
     <script>
			...
			const insuranceempid = encodeURIComponent("<?php echo $insuranceempid; ?>");

			window.location.href = `personnelinsureempedit.php?loginid=${loginid}&eid=${employeeid}&ieid=${insuranceempid}`;
		</script>
          <?php
