...
if($crvnumber0 != '')
{
  $result15 = mysql_query("SELECT cashreceiptnumber, payor, date, explanation, companyid, contactid FROM tblfincashreceipt WHERE cashreceiptnumber = \"$crvnumber0\"", $dbh);
  ...
  while($myrow16 = mysql_fetch_row($result16))
  {
    ...
    echo "<tr><td>Date:&nbsp;<b><u>".date("Y-M-d", strtotime($crvdate15))."</u></b></td><td align=\"right\">C.R. No.:&nbsp;<b><u>$crvnumber15</u></b></td></tr>";
		echo "<tr><td colspan=\"2\">Received by:&nbsp;";
	...
	echo "</tr>";
      ...
      echo "<tr><td>&nbsp;</td><td><i>$explanation16</i></td><td>&nbsp;</td><td>&nbsp;</td></tr>";
	  echo "<tr><td>&nbsp;</td><td><i>$explanation16</i></td><td>&nbsp;</td><td>&nbsp;</td></tr>";
...
else
{
  ...
  else
  {
    ...
    echo "<tr><td colspan=\"2\"><table class=\"fin\" width=\"100%\" border=\"1\" spacing=\"0\" cellspacing=\"0\" cellpadding=\"0\">";
      ...
      $result17 = mysql_query("SELECT cashreceiptid, glcode, glnamedetails, projcode, particulars, debitamt, creditamt FROM tblfincashreceipt WHERE cashreceiptnumber = \"$crvnumber\" ORDER BY cashreceiptid ASC", $dbh);
      while ($myrow17 = mysql_fetch_row($result17))
      {
	$found17 = 1;
	$cashreceiptid17 = $myrow17[0];
  ...
  while($myrow16 = mysql_fetch_row($result16))
  {
    ...
    echo "<textarea rows=\"4\" cols=\"60\" name=\"explanation\" readonly>$explanation</textarea></td></tr>";
