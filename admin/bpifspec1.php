<?php
	...
	echo "<option value=1 $month01sel>Jan</option>";
	echo "<option value=2 $month02sel>Feb</option>";
	echo "<option value=3 $month03sel>Mar</option>";
	echo "<option value=4 $month04sel>Apr</option>";
	echo "<option value=5 $month05sel>May</option>";
	echo "<option value=6 $month06sel>Jun</option>";
	echo "<option value=7 $month07sel>Jul</option>";
	echo "<option value=8 $month08sel>Aug</option>";
	echo "<option value=9 $month09sel>Sep</option>";
	echo "<option value=10 $month10sel>Oct</option>";
	echo "<option value=11 $month11sel>Nov</option>";
	echo "<option value=12 $month12sel>Dec</option>";
	echo "</select>";
	...
	echo "<tr><td align=\"right\">Payroll Time</td><td>";
	echo "<select name=\"paytimehh\">";
	...
	echo "</select>";
	echo ":";
	echo "<select name=\"paytimemm\">";
	echo "<option value=\"00\">00</option>";
	echo "<option value=\"15\">15</option>";
	echo "<option value=\"30\">30</option>";
	echo "<option value=\"45\">45</option>";
	echo "</select>";
	echo "<select name=\"paytimeampm\">";
	echo "<option value=\"AM\">AM</option>";
	echo "<option value=\"PM\">PM</option>";
	echo "</select>";
	echo "</td></tr>";
	
	echo "<tr><td align=\"right\">Funding Account</td><td><input name=compacctnumber value=";
	...
	// label for new bpi bizlink above
	echo "<tr><td colspan=\"2\" align=\"center\"><i>Requirements for new BPI BizLink details above</i></td></tr>";
	
	// divider line
	echo "<tr><td colspan=\"2\"><hr></td></tr>";

	// label for old bpi expresslink below
	echo "<tr><td colspan=\"2\" align=\"center\"><i>Requirements for old BPI ExpressLink details below</i></td></tr>";
