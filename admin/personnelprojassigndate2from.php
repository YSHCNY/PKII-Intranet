...
//	  $employeeid = $myrow[0];
	...
	echo "<tr><td>Current Date (From)</td><td align=center>$durationfrom2<br><font size=1><i>YYYY-MM-DD</i></font></td></tr>";
	echo "<tr><td>New Date (From)</td><td>";

	echo "<form action=personnelprojassigndate2from2.php?loginid=$loginid&eid=$employeeid&prjid=$projassignid method=POST>";
