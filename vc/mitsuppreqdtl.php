...
<div class="text-center"><h3 class = 'mb-5 mt-2 py-5 fw-bold text-uppercase text-white'>it support request - details</h3></div>
		</div>
            ...
            <div class = 'text-end mb-0 pb-0'>
                ...
                <?php include '../m/qrymitsuppreq5.php'; ?>
                        ...
                        <div class="col-md-6">
                            ...
                            <p class=" p-2 <?php echo $subtext?>"><span class = '<?php echo $maintext?>'>Date of request:  </span><?php echo  date("Y-M-d H:i:s", strtotime($stamprequest16)); ?></p>
                            ...
                            <div class="col-md-6 text-start text-md-end">
                                    ...
                                    <?php if($ticketnum16==0): ?>
                                        <p class=""><span class = ' <?php echo $maintext?> rounded text-center p-3'>NO ticket number assigned</span></p>
                                    <?php else: ?>
                                        <p class = '' ><span class = 'secondarybgc  text-white rounded text-center p-3'><?php echo $ticketnum16; ?></span></p>
                                    <?php endif; ?>
...
<!-- requests -->
                    ...
                    <h4 class = 'fw-bold <?php echo $maintext?> text-center'> Requestor -    
                        <?php echo " $name_first17 $name_middle17[0]  $name_last17 "; ?> <span class = 'fw-normal'>of</span>
                            ...
                            <?php endif; ?></h4>
                    <div class="p-3">
                    <p class = '<?php echo $subtext?> mb-1 fs-6'>Request/s:</p>
                    ...
                    for($x2 = 0; $x2 < $param14; $x2++) {
                        ...
                        <p class = 'fs-5 fw-bold my-2'><span class="<?php echo $maintext?>"><?php echo $name14Arr[$x2];?></span></p> 
...
<!-- details -->    <div class = 'p-3'>
                    <p class = '<?php echo $subtext?> mb-1 fs-6'>Details:</p>
                    <p><span class = '<?php echo $maintext?> fs-5 '><?php echo nl2br($details16); ?></span></p>
                    </div>
<!-- status --> 
                    <div class = 'p-3'>
                    <p class = '<?php echo $subtext?> mb-1 fs-6'>Approval status:</p>
                    <p class = 'fs-5'>
                    ...
                    <div class = 'p-3'>
                    <p class = '<?php echo $subtext?> mb-1 fs-6'>Approval date:</p>
                    <p class = 'fs-5'>
                    <?php echo ($apprdurationsw16 == 1) ? date('F d, Y', strtotime($apprdurationdt16)) : "<span class = 'maintext'>No Approval Duration</span>";
                    ?>
                    </p>
                    </div>

                    <div class="p-3">
                    <p class = '<?php echo $subtext?> pb-0 fs-6 mb-1'>Approver:</p>
                    <?php if($approvectr16==1) {
                            // query tblcontact for approveempid16
                            include '../m/qrymitsuppreq8a.php';
                            echo "<p><span class = 'fs-5 $maintext'>$name_last18a, $name_first18a  $empposition18a</span></p>";
                            ...
                            echo "<select  class = 'border rounded p-2 $mainbg fs-5' name=\"approver\">";
                            include '../m/qrymitsuppreq8b.php';
							if($approveempid16==$approver1empid18b) {
								$appr1eid16sel="selected"; $appr2eid16sel=""; $appr3eid16sel="";
							} else if($approveempid16==$approver2empid18b) {
								$appr1eid16sel=""; $appr2eid16sel="selected"; $appr3eid16sel="";								
							} else if($approveempid16==$approver3empid18b) {
								$appr1eid16sel=""; $appr2eid16sel=""; $appr3eid16sel="selected";

							} //if-else
                            if($approver1empid18b!='') {
                                include '../m/qrymitsuppreq8c.php';
                                echo "<option value=\"$approver1empid18b\" $appr1eid16sel>$name_last18c, $name_first18c $name_middle18c[0]";
                            ...
                            if($approver2empid18b!='') {
                                ...
                                echo "<option value=\"$approver2empid18b\" $appr2eid16sel>$name_last18d, $name_first18d $name_middle18d[0]";
                                if($empposition18d!='') { echo " - $empposition18d"; } // if
                                if($empdepartment18d!='') { echo " - $empdepartment18d"; } // if
                                echo "</option>";
                            } // if
                            if($approver3empid18b!='') {
                                include '../m/qrymitsuppreq8d2.php';
                                echo "<option value=\"$approver3empid18b\" $appr3eid16sel>$name_last18d2, $name_first18d2 $name_middle18d2[0]";
                                if($empposition18d2!='') { echo " - $empposition18d2"; } // if
                                if($empdepartment18d2!='') { echo " - $empdepartment18d2"; } // if
                                echo "</option>";
                            } // if
                            echo "</select>";
                    ...
                    <?php if($employeeid16==$employeeid0): ?>
                        ...
                        <?php if($approvectr16==0): ?>
                            <form method="POST" action="mitsuppreq2.php?lst=1&lid=<?php echo $loginid; ?>&sess=<?php echo $session; ?>&p=342" name="mitsuppreq2">
                                ...
                                <button type="submit" class=" rounded px-3 py-2  border secondarybgc text-white mt-1">Request Reevaluation</button>
                                </div>
                            </form>
                        <?php endif; ?>
                    </div>
               ...
               <h4 class = 'fw-bold <?php echo $maintext?> text-center'>From Approver</h4>
                    <?php if($actionctg16!=''): ?>
                        ...
                        <?php if($found19==1): ?>
                            <?php if($actionctg16=='acc'): ?>
                                 <p class = '<?php echo $subtext?> pb-0 fs-6 mb-0'>Action taken:</p>
                        ...
                        <?php if($actiondetails16!=''): ?>
                            <p class = '<?php echo $subtext?> pb-0 mb-0 fs-6 mb-0'>Comment from approver:</p>
                            <p class = '<?php echo $maintext?> fs-5 mb-5'><?php echo nl2br($actiondetails16); ?></p><?php endif; ?>
                    <?php endif; ?>
                    </div>
                    ...
                    <?php if($closeticketsw16==0): ?>
                        <?php if($ticketnum16==0): ?>
                            <!-- Display nothing -->
                        <?php else: ?>
                            <p class = '<?php echo $subtext?> pb-0 fs-6 mb-1'>Ticket status:</p>
                           <p class = 'fs-5 <?php echo $maintext?>'> OPEN</p> 
                        <?php endif; ?>
                    ...
                    <div class=" px-5 py-2  flex">
                        <div class = ' '> 
                        <!-- <p class = 'fs-6 <?php echo $subtext?>  mb-0'>Necessarry Actions</p> -->
                        <div>
                    ...
                    <?php if($approveempid16==$employeeid0): ?>
                        ...
                        <?php if($approvectr16==0): ?>
                            ...
                            <form method="POST" action="mitsuppreq2.php?lst=1&lid=<?php echo $loginid; ?>&sess=<?php echo $session; ?>&p=342" name="mitsuppreq2">
                                ...
                                if ($apprdurationdt16 != "") {
                                    $apprdurationswdtval = date('Y-M-d', strtotime($apprdurationdt16));
                                } else {
                                    $apprdurationswdtval = $datenow;
                                }                                
                                    echo "<p class = 'text-danger fw-semibold fs-5'>(Optional) Allowed duration of request</p>";
                                    echo "<div class=\"checkbox\">";

                                        echo "<label>";
                                            echo "<input type=\"checkbox\" name=\"apprdurationsw\" $apprdurationswval onclick=\"toggleDateInput(this)\"> Yes";
                                        echo "</label>";
                                        
                                        echo "<label>";
                                            echo "<input type=\"date\" class=\"form-control\" name=\"apprdurationdt\" value=\"$apprdurationswdtval\"";
                                            echo ($apprdurationswval == 'checked') ? '' : ' disabled';
                                            echo ">";
                                        echo "</label>";

                                        echo '<script>
                                                    function toggleDateInput(checkbox) {
                                                        var dateInput = checkbox.parentElement.nextElementSibling.querySelector(\'input[type="date"]\');
                                ...
                                <div class="text-end">
                                <?php
                                    $requestDate = new DateTime($stamprequest16);
                                    $currentDate = new DateTime();
                                    $currentDateMinus15Days = (new DateTime())->modify('-15 days');
                                    
                                    if ($requestDate >= $currentDateMinus15Days) {
                                        ?>
                                        <button type="submit" class="rounded px-3 py-2 border-0 secondarybgc text-white mt-1">Approve Request</button>
                                        <?php
                                    } else {
                                        ?>
                                        <p class="text-danger fw-semibold mt-1">Request Expired</p>
                                        <?php
                                    }
                                ?>
                                </div>
                    ...
                    <style>
                        ...
                        <div class = ' '> 
                                    <form method="POST" action="mitsuppreqscore.php?lst=1&lid=<?php echo $loginid; ?>&sess=<?php echo $session; ?>&p=342" name="mitsuppreqscore">
                                        ...
                                        <p class = '<?php echo $maintext?> text-center mb-0 fs-2'> What is your rating?</p>
                                        <p class = 'fs-5 <?php echo $subtext?>  text-center '>Your ticket has been approved, Help us improve our service by rating us!</p>
                                    ...
                                    <div  class = 'flex'>
                                        <h5 class = '<?php echo $subtext?> text-center'>Help us improve, Comment your thoughts on our service</h5>
                                        <textarea class = 'form-control w-75 <?php echo "$mainbg $maintext"?> mx-auto' placeholder = 'Comments here..' name="scoreremarks"></textarea> 
                                        <div class="flex mx-auto text-center mt-2 p-3">
                                        <button class="text-white secondarybgc px-4 py-3 border-0 rounded" type="submit">Submit score</button>
                                        </div>
                                        </div>
                                    </form>
                                <?php else: ?>
                                    ...
                                    <?php 
                                            ...
                                            <p class = '<?php echo $maintext?> text-center mb-0 fs-2'>Your Rate</p>
                                            <p class = 'fs-5 <?php echo $subtext?>  text-center '>Thank you for rating! It help us to be better!</p>
                                            ...
                                            <?php if ($scorestamp16 != '0000-00-00 00:00:00'): ?>
                                                <p class="<?php echo $subtext?> fs-6 mb-0">Date of Rating</p>
                                                <p class="<?php echo $maintext?> fs-5"><?php echo date("Y-M-d H:i:s", strtotime($scorestamp16)); ?></p>
                                            <?php endif; ?>

                                            <?php if ($scoreremarks16 != ''): ?>
                                                <p class="<?php echo $subtext?> fs-6 mb-0">Your Comment</p>
                                                <p class = '<?php echo $maintext?> fs-5' ><?php echo nl2br($scoreremarks16); ?></p>
                                            <?php endif; ?>
                                            </div>
                                            </div>
...
.score-text {
    ...
    ratingInputs.forEach(input => {
        input.addEventListener('change', function() {
            ...
            if (this.checked) {
                selectedRating.textContent = percentage;
                selectedRating.classList.add('<?php echo $maintext?>');
            } else {
                selectedRating.textContent = '-';
                selectedRating.classList.remove('<?php echo $maintext?>');
            }
                    ...
                    <p class="mt-4 fs-6 <?php echo $subtext?>">Comments/clarification area</p>
                    <?php if($closeticketsw16!=1): ?>
                        <form method="POST" action="mitsuppreqcomments.php?lst=1&lid=<?php echo $loginid; ?>&sess=<?php echo $session; ?>&p=342" name="mitsuppreqcomments">
                            ...
                            <div class="text-end">
                                    <button class=" rounded px-3 py-2  border-0 secondarybgc text-white mt-1" type="submit">Send <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-send" viewBox="0 0 16 16"><path d="M15.854.146a.5.5 0 0 1 .11.54l-5.819 14.547a.75.75 0 0 1-1.329.124l-3.178-4.995L.643 7.184a.75.75 0 0 1 .124-1.33L15.314.037a.5.5 0 0 1 .54.11ZM6.636 10.07l2.761 4.338L14.13 2.576zm6.787-8.201L1.591 6.602l4.339 2.76z"/></svg> 
                                    </button>
                            </div>
                        </form>
                    <?php endif; ?>
                    <div class="mt-4">
                        <p class = 'fs-5 <?php echo $maintext?>'><?php echo nl2br($comments16); ?></p>
                    </div>
                    </div>
