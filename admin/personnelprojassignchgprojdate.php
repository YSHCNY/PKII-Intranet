...
if ($found == 1)
{
     ...
     echo "<p><font size=1>Directory >> Manage Personnel >> Edit Project Assignment >> Change date</font></p>";

     echo "<table border=1 spacing=0 cellspacing=0 cellpadding=0>";
     echo "<tr><td bgcolor=blue colspan=2><font color=white><b>Change Date</b></font></td></tr>";
...
//	  $employeeid = $myrow[0];
	...
	echo "<tr><td>Current Date</td><td align=center>$proj_date<br><font size=2><i>yyyy-mm-dd</i></font></td></tr>";
	echo "<tr><td>New Date</td><td>";

	echo "<form action=personnelprojassignchgprojdate2.php?loginid=$loginid&eid=$employeeid&prjid=$projassignid method=POST>";
