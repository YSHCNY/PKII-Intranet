...
?>
  ...
  <div class="row">
    ...
    <div class="col-md-2"><img src="./images/Icon_gray_apply_for_programs.png" alt="Apply_cpd_programs" width="80" height="80"><br><p style="color:#727880;">Apply for CPD Programs</p><?php // echo "<a href=\"index.php?lst=1&lid=$loginid&sess=$session&p=384.php\">"; ?></div>
