...
?>
	...
	<div class="bg-white">
		<div class="">
			<p class="text-muted fs-4 fw-bold ">Holidays</p>
		</div>
		<?php
				...
				<div id="" class="text-center">
					<?php if ($holidaytype012 == "special" || $holidaytype012 == "legal"): ?>
						<?php if ($applic_date012 == $datenow): ?>
							<p class = 'fs-4 text-info fw-bold '><?php echo $holidayname012; ?></p>
							<p class = 'fs-4 '><?php echo date("M d, Y (D)", strtotime($applic_date012)); ?></p>
						<?php else: ?>
							<p class = 'fs-4 text-info fw-bold '><?php echo $holidayname012; ?></p>
							<p class = 'fs-4 '><?php echo date("M d, Y (D)", strtotime($applic_date012)); ?></p>
						<?php endif; ?>
