...
// headprint.php
// to be used for print view only of vouchers where fixed footer to be displayed in bottom of last page
...
<title>PKII Intranet - Admin Login</title>
...
table.fin thead th, table.fin tfoot th { background:#5C443A;
 color:#FFFFFF;
...
table.fin tbody tr:hover { background:#99BCBF;
...
<body>
<table width=100% border=0 spacing=0>
<tr><td align=left>
<img src=pkiilogo1.gif name=pkiilogo1>
</td></tr>
<tr><td height="3" background="line2.gif"></td></tr></table>
