...
<?php
        // title head
        echo "<tr><th colspan='8' class='text-left'>Philkoei International, Inc.</th></tr>";
        echo "<tr><th colspan='8' class='text-left'>Subsidiary Ledger</th></tr>";
        echo "<tr><th colspan='8' class='text-left'>For the period ".date('F Y', strtotime($fromDate))." to ".date('F Y', strtotime($toDateOri))."</th></tr>";
