...
// start contents here
    ...
    echo "<form action=\"diradmmtgrm.php?loginid=$loginid\" method=\"POST\" name=\"diradmmtgrm\">";
    // display dropdown
...
if($mtgrmcodeid!='') {
    ...
    $eqptlst14 = $myrow14['eqptlst'];
				...
				echo "<tr>";
				echo "<td>$ctr14</td><td>".date('D Y-M-d', strtotime($datemeeting14))."</td><td>".date('g:ia', strtotime($timedurfrom14))." to ".date('g:ia', strtotime($timedurto14))."</td><td>$name14</td><th class='text-left'>$projnamefin</th><td>$topic14</td>";
				/*
