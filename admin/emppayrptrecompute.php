...
echo "<table width=\"100%\" class=\"fin\" border=\"1\">";
    ...
    $netpay2020 = $grosspay - $deductionstotal2020;
      ...
      // echo "<br>newwtax:$wtax2020=($comprate2(comprate2)-$crmin14(crmin))*($percent14(pct)/100) + $prescramt14(prescramt)";
			...
			// echo "<br>ctwt:$cutwhat,cutst:$cutstart,yr:$cutyear<br>nbasic:$subtotnetbasicpay,f15a/b:$found15a/$found15b,id:$idphilhealth202015,maxprem:$maxpremium,f152a/b:$found152a|$found152b,ph20k:$philhealth2020";
			// echo "<br>qry:$res15bquery";
			echo "</td>";
