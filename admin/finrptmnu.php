...
// start contents here
    ...
    echo "<form action=\"finrptotheracctssummapb.php?loginid=$loginid\" method=\"post\">";
    ...
    echo "<td align=\"center\"><button type=\"submit\" class=\"btn btn-primary\" role=\"button\">General Ledger</button></td></form>";
    echo "<td>PKII's General Ledger</td>";
    echo "</tr>";
