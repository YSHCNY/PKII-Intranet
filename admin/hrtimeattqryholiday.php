...
//
		$res21query = "SELECT idhrtaholidays, holidayname, holidaytype, shiftin, shiftout FROM tblhrtaholidays WHERE applic_date=\"$cutstartfin\" AND (holidaytype=\"special\" OR holidaytype=\"legal\" OR holidaytype=\"shortened\")";
