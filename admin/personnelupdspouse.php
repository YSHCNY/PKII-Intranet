...
//	  $employeeid = $myrow0[0];
	...
	if($found0 == 1) {
	  $result = mysql_query("UPDATE tblempspouse SET empspouselast = \"$empspouselast\", empspousefirst = \"$empspousefirst\", empspousemiddle = \"$empspousemiddle\" WHERE employeeid=\"$employeeid\"", $dbh) or die ("Couldn\'t execute query.".mysql_error());
	} else {
	  $result = mysql_query("INSERT INTO tblempspouse SET employeeid=\"$employeeid\", empspouselast = \"$empspouselast\", empspousefirst = \"$empspousefirst\", empspousemiddle = \"$empspousemiddle\"", $dbh) or die ("Couldn\'t execute query.".mysql_error());
	}
