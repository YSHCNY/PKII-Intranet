...
// edit body-header
		...
		$colspan=9;
	echo "<div class='shadow d-flex flex-column align-items-center rounded' style='padding: 0 5% 5% 5%;'>";

     echo "<table class=\"fin w-100\">";
...
// start contents here...
  if($accesslevel >= 3) {
	...
	echo "</select></td></div>";
	// echo "$empstat, $empstatactsel, $empstatinactsel, $empstatallsel"
    ...
    echo "<td class='text-center'><button type=submit class='btn btn-success px-5' name='submit' value='1'>Submit</button></td></form></tr>";
    echo "</table><br>";
// echo "<tr><td colspan='$colspan'>r11q: ".$res11qry."</td></tr>";
    ...
    if($employeeid01!='') {
        ...
        echo "<table id=\"ReportTable\" class=\"fin w-100\" border=\"1\">";
        echo "<tr><th colspan=\"$colspan\" class='py-3'><div class='d-flex justify-content-center align-items-center gap-3'>";
        echo "<form action=\"hrofctimelogprtvw.php?loginid=$loginid\" method=\"POST\" target=\"_blank\" name=\"hrofctimelogprtvw\" class='m-0 align-middle'>";
        ...
        echo "<button type=\"submit\" class=\"btn btn-info btn-sm\">Printable View</button>";
        echo "</form>";
        echo "<a href=\"#\" id=\"exportToExcel\"><i class='bi bi-file-earmark-arrow-down-fill fs-1 text-primary'></i></a></div></th></tr>";
...
echo "</td>";
    ...
    echo "<th></th>";
                ...
                echo "</tr>";
		echo "<tr><th colspan='$colspan' class='text-center'><button type='submit' class='btn btn-success' style='padding: 10px 70px;' name='act' value='validate'>Save</button></th></tr>";
		echo "</form>";
	} //if($employeeid01!='')
  }
...
// edit body-footer
  	echo "<div class='w-100 d-flex justify-content-between align-items-center mt-5'>";
    	echo "<p class='m-0 poppins'><a href=\"hrofctimelog.php?loginid=$loginid\" class='btn btn-default' role='button'>Back</a></p>";
    	echo "<p class='m-0 poppins'><a href=\"index2.php?loginid=$loginid\" class='btn btn-default' role='button'>Back to Dashboard</a></p>";
	echo "</div>";
