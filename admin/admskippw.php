...
// start contents here
    ...
    $result11=$dbh2->queyr($res11query);
    ...
    if($found11==1) {
        ...
        $skiplastdt = date('Y-m-d', strtotime('+1 month', $datenow));
        if($skiplastdt11<$datenow) {
        // update query
        $res12query=""; $result12=""; $found12=0;
        $res12query="UPDATE tblsysusracctmgt SET skippwctr=$skippwctr, skiplastdt=\"$skiplastdt\" WHERE idtblsysusracctmg=$idtblsysusracctmgt11";
        ...
        $res14query="SELECT idtblsysusracctmgt, admloginid, employeeid, pwchangedt, skippwctr, skiplastdt FROM tblsysusracctmgt WHERE loginid=$loginid AND employeeid=\"$employeeid11\" LIMIT 1";
        ...
        $res15query="UPDATE tblsysusracctmgt SET skippwctr=$skippwctr2, skiplastdt=\"$skiplastdt\" WHERE idtblsysusracctmg=$idtblsysusracctmgt14";
