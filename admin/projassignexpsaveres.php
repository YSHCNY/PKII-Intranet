...
// start contents here...
	...
	while($myrow1 = mysql_fetch_row($result1))
	{
	  ...
	  $remarks = $myrow1[11];
		$idhrpositionctg = $myrow1[12];
	  $name_last = $myrow1[13];
	  $name_first = $myrow1[14];
	  $name_middle = $myrow1[15];
	...
	while($myrow2 = mysql_fetch_row($result2))
	{
	  ...
	  $remarks2 = $myrow2[11];
		$idhrpositionctg2 = $myrow2[12];
	  $name_last2 = $myrow2[13];
	  $name_first2 = $myrow2[14];
	  $name_middle2 = $myrow2[15];
