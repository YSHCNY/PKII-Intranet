...
if ($found == 1)
{
  ...
  if($accesslevel >= 4 && $accesslevel <= 5)
  {
    ...
    $result11 = 0; $found11 = 0;
    $result11 = mysql_query("SELECT contactid, name_last, name_first, name_middle FROM tblcontact WHERE contactid=$contactid0", $dbh);
    if ($result11 != '')
    {
...
// display new record
      ...
      echo "projcode:$proj_code, emppersid:$employeeid0, relation:$persrelation<br>";
      echo "</td></tr>";
      ...
      $adminlogdetails = "$loginid:$adminloginuid - edit personal contact record in business directory:$companyid - $name_first $name_middle $name_last";
