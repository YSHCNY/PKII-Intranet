...
echo "<tr><td>count</td><td>disbid</td><td>voucher</td><td>date</td><td>glcode</td><td>ver</td><td>gldetails</td><td>projcode</td><td>particulars</td><td>debit</td><td>credit</td><td>explanation</td></tr>";

  $count1 = 0;
  $found1 = 0;

  $result1 = mysql_query("SELECT disbursementid, disbursementnumber, disbursementtype, payee, date, glcode, glrefver, glnamedetails, projcode, particulars, debitamt, creditamt, explanation FROM tblfindisbursement WHERE disbursementnumber LIKE '%.%' ORDER BY date ASC, disbursementnumber ASC", $db24);
  while ($myrow1 = mysql_fetch_row($result1))
  {
    ...
    echo "<tr><td>$count1</td><td>$disbursementid1</td><td>$disbursementnumber1</td><td>$date1</td><td>$glcode1</td><td>$glrefver1</td><td>$glnamedetails1</td><td>$projcode1</td><td>$particulars1</td><td align=\"right\">$debit1</td><td align=\"right\">$credit1</td><td>$explanation1</td></tr>";
