...
// edit body-header
  ...
  if(isset($_POST['fromDate'])) {
    ...
    if($apvdrtot<0) {
    echo "<th align=\"right\"><span style='color:red'>(".number_format($apvdrtot, 2).")</span></th>";
    } else {
    echo "<th align=\"right\">".number_format($apvdrtot, 2)."</th>";
    } //if-else
    if($apvcrtot<0) {
    echo "<th align=\"right\"><span style='color:red'>(".number_format($apvcrtot, 2).")</span></th>";
    } else {
    echo "<th align=\"right\">".number_format($apvcrtot, 2)."</th>";
    } //if-else
