...
//    $disbursementnumber11 = $myrow11[0];
  ...
  echo "<tr><td colspan=\"2\" align=\"center\"><font color=\"red\"><b>Deleting CV record.</td></tr>";
  ...
  {
    echo "<form method=\"post\" action=\"finvouchcvdel2.php?loginid=$loginid&cvn=$cvnumber\">";
