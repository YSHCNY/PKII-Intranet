...
//	  $employeeid = $myrow0[0];
	...
	echo "<p>Duration2 end date changed for: <b>$employeeid - $name_last, $name_first $name_middle[0]</b></p>";

	$result = mysql_query("UPDATE tblprojassign SET durationto2 = '$newdate'
		WHERE employeeid='$employeeid' AND projassignid = '$projassignid'", $dbh) or die ("Couldn't execute query.".mysql_error());

	echo "durationto2 = $newdate<br>";
