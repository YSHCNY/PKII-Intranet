...
// create log
    ...
    { $adminuid=$myrow16[0]; }
    $adminlogdetails = "$loginid:$adminloginuid - Add new NK-Stravis Form-A item with details: date:$transdate, sheet:$frmasheet, $acctcode-$name_e11, value:$transvalue, projcode:$projcode, amtcurrtyp:$amtincurr-$currtyp, content:$transcontent, acctctrpart:$accttranscounterpart, remarks:$remarks";
