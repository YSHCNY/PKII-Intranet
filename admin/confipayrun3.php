...
if($confiaccesslevel==5 && $validatepw==0) {
	...
	*/
	...
	$res2query="SELECT tblconfipaymemadd.employeeid, tblconfipaymemadd.groupname, tblconfipaymemadd.nameadd, tblconfipaymemadd.addamount, tblconfipaymemadd.nontaxable, tblconfipaymemadd.statusadd, tblconfipaymemadd.addincomevatincl, tblconfipaymeminfo.empalias FROM tblconfipaymemadd LEFT JOIN tblconfipaymeminfo ON tblconfipaymemadd.employeeid=tblconfipaymeminfo.employeeid AND tblconfipaymemadd.groupname=tblconfipaymeminfo.groupname WHERE tblconfipaymemadd.statusadd=\"active\" AND tblconfipaymemadd.groupname=\"$groupname\" AND tblconfipaymeminfo.empstatus=\"active\" ORDER BY tblconfipaymemadd.employeeid ASC";
	...
	$res3query="SELECT tblconfipaymemdeduct.employeeid, tblconfipaymemdeduct.groupname, tblconfipaymemdeduct.namededuct, tblconfipaymemdeduct.deductamount, tblconfipaymemdeduct.statusdeduct, tblconfipaymeminfo.empalias FROM tblconfipaymemdeduct LEFT JOIN tblconfipaymeminfo ON tblconfipaymemdeduct.employeeid=tblconfipaymeminfo.employeeid AND tblconfipaymemdeduct.groupname=tblconfipaymeminfo.groupname WHERE tblconfipaymemdeduct.groupname=\"$groupname\" AND tblconfipaymeminfo.empstatus=\"active\" AND tblconfipaymemdeduct.statusdeduct=\"active\" ORDER BY tblconfipaymemdeduct.employeeid ASC";
