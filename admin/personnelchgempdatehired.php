...
<?php
     echo "<p><font size=1>Directory >> Manage Personnel >> Change date hired</font></p>";

     echo "<table class=\"fin\" border=1 spacing=0 cellspacing=0 cellpadding=0>";
     echo "<tr><td bgcolor=blue colspan=2><font color=white><b>Change Date Hired</b></font></td></tr>";
	...
	// echo "<tr><td>Current Date</td><td align=center>$date_hired<br><font size=2><i>yyyy-mm-dd</i></font></td></tr>";

	echo "<form action=\"personnelchgdatehired2.php?loginid=$loginid&pid=$pid\" method=\"POST\" name=\"empchgdatehired\">";

	echo "<tr><th align=\"right\">Date hired</th><td>";
		/*
	echo "<input name=year size=4 value=2010>";
     ...
     echo "</select>";
		*/
		echo "<input type=\"date\" name=\"datehired\" size=\"10\" value=\"$date_hired\">";
		?>
		<a href="javascript:show_calendar('document.empchgdatehired.datehired', document.empchgdatehired.datehired.value);"><img src="./images/cal.gif" width="16" height="16" border="0" alt="Click Here to Pick up the timestamp"></a>
		<?php
		echo "</td></tr>";
