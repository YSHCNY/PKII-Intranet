...
// start contents here
    ...
    echo "<tr>";
    echo "<form action=\"emppayrpttax.php?loginid=$loginid&submitsw=1\" method=\"post\" name=\"emppayrptbasic\">";
	...
	// if(($datefrom <= $dateto) && (($datefrom != '') && ($dateto != ''))) {
		...
		echo "<tr><th colspan=\"2\" align=\"left\">Employees Payroll - Tax&nbsp;<a href=\"#\" id=\"exportToExcel\"><img src=\"./images/sheet.gif\"></a></th></tr>";
    ...
    echo "<tr><td colspan=\"2\">";
		...
		if($result14 != "") {
			...
			if($result15 != "") {
				...
				$result16 = mysql_query("SELECT tax FROM tblemppayroll WHERE employeeid=\"$employeeid14\" AND cut_start=\"$cut_start15\" AND cut_end=\"$cut_end15\"", $dbh);
				if($result16 != "") {
				...
				$emptaxtot = $emptaxtot + $tax16;

				if($found16 == 1) {
					echo "<td align=\"right\">".number_format($tax16, 2)."</td>";
				} else {
					echo "<td></td>";
				}
				$tax16=0;
			...
			echo "<th>".number_format($emptaxtot, 2)."</th></tr>";
