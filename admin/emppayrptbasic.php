    ...
    echo "<tr><td colspan=\"2\">";
		...
		if($result14 != "") {
			...
			if($result15 != "") {
				...
				$result16 = mysql_query("SELECT emp_salary, totaltardy, absentamt FROM tblemppayroll WHERE employeeid=\"$employeeid14\" AND cut_start=\"$cut_start15\" AND cut_end=\"$cut_end15\"", $dbh);
				if($result16 != "") {
					while($myrow16 = mysql_fetch_row($result16)) {
					$found16 = 1;
					$emp_salary16 = $myrow16[0];
					$totaltardy16 = $myrow16[1];
					$absentamt16 = $myrow16[2];
					$empbasic = ($emp_salary16 / 2) - ($totaltardy16 + $absentamat16);
					}
				}
