...
?>
     ...
     <button class="bg-primary-subtle border border-1 border-primary rounded-3" style="width: 12.5%; height: 40px;">
         <a href="<?php echo 'index2.php?loginid=' . $loginid ?>" class="text-black text-decoration-none poppins fw-medium fs-4">Back</a>
     </button>
     </div>
<?php
// end contents here
