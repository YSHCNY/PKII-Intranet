...
?>
  ...
  <div class="row">
    ...
    <div class="col-md-2"><img src="./images/Icon_gray_CPD_Program_Catalogue.png" alt="Program_catalogue" width="80" height="80"><br><p style="color:#727880;">CPD Program Cataloque</p><?php // echo "<a href=\"index.php?lst=1&lid=$loginid&sess=$session&p=383.php\"></a>"; ?></div>
