...
// start contents here...
	...
	// title head
	echo "<tr><th colspan=\"2\"><font color='red'>Deleting contract</font></th></tr>";

	// Other infos
	echo "<tr><td colspan='2' align='center'><h3><font color='red'>Are you sure?</font></h3></td></tr>";
	echo "<tr><td colspan='2' align='center'>Project code: $proj_code<br>ContractID: $contract_id</td></tr>";
	echo "<tr><td colspan='2' align='center'><font color='red'>WARNING: This contract will be deleted including its invoices and attachments.</font></td></tr>";

  echo "<tr>";
	echo "<form action='projbillcontrdel2.php?loginid=$loginid' method='POST' name='projbillcontrdel2'>";
