...
echo "<tr><td>count</td><td>crvid</td><td>crvnum</td><td>date</td><td>debit</td><td>credit</td><td>debittot</td><td>credittot</td><td>status</td><td>explanation</td></tr>";
  ...
  $result1 = mysql_query("SELECT cashreceiptid, cashreceiptnumber, date, debitamt, creditamt, explanation FROM tblfincashreceipt WHERE cashreceiptid <> '' ORDER BY date ASC, cashreceiptnumber ASC", $db24);
  while ($myrow1 = mysql_fetch_row($result1))
  {
    ...
    if ($status != "pending")
    {
      echo "<tr><td colspan=\"2\"><font color=\"green\">Saving</font></td><td><font color=\"green\"><b>$disbursementnumber1</b></font></td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td align=\"right\">$debittot</td><td align=\"right\">$credittot</td><td>$status</td><td>$explanation1</td></tr>";

      $result2 = mysql_query("INSERT INTO tblfincashreceipttot SET cashreceiptnumber=\"$cashreceiptnumber1\", date=\"$date1\", explanation=\"$explanation1\", debittot=$debittot, credittot=$credittot, status=\"$status\"", $db24);
    }
