...
<?php
        echo "<td class='px-2 poppins'>$proj_code</td>";
        echo "<td class='poppins'>$proj_sname</td>";
        echo "<td class='poppins'>$proj_fname</td>";
        echo "<td class='poppins'>$proj_services</td>";
        echo "<td class='px-2 text-center poppins'>$proj_period</td>";
        echo "<td class='poppins'>$pkiictgcd</td>";
        echo "<td class='poppins'>";
        ...
        echo "</td>";
        echo "<td class='poppins'>$proj_class</td>";
