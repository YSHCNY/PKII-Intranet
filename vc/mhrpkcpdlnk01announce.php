...
?>
  ...
  <div class="row">
    ...
    <div class="col-md-2"><img src="./images/Icon_gray_latest_announcements.png" alt="Latest_announcement" width="80" height="80"><br><p style="color:#727880;">Latest Announcements</p>
<?php // echo "<a href=\"./index.php?lst=1&lid=$loginid&sess=$session&p=381.php\"></a>"; ?></div>
